   ...
   $data['closingAmount'] = $closingFGStock;
     ...
     /*   $allexpasne =  DB::table('payments')->select([
      ...
      if($days->days <= 30){
        ...
        //dd($expenseData);
        $salesRevenue = ($totalIncome + $data['sales']) - $data['sales_return'];
