...
*/
     // dd($today_purchase);
      ...
      /* $month12datasales = Sale::select([
                          ...
                          $fgOB = $this->totalFgOb('2023-10-01', $today);
                          $rmOB = $this->totalRmOb('2023-10-01', $today);
                          $supplierOB = $this->totalSupplierOb('2023-10-01', $today);
                          $dealerOB = $this->totalDealerOb('2023-10-01', $today);
     ...
     /* $totalRawStock = ChartOfAccounts::select( DB::raw('SUM(debit) - SUM(credit)  as balance'))->where('ac_sub_sub_account_id',10)->get();
      ...
      $data['totalAcReceivable'] = $totalAcReceivable[0]->balance + $dealerOB; */
        ...
        $individualAccountInfo = $this->getChartOfAccountInfo('2023-10-01', $today);
