    ...
    <div class="content px-4 ">
        <div class="container-fluid">
            <div class="pt-3 text-center">
                <h4 class="font-weight-bolder text-uppercase">Production Factory Create</h4>
                <hr width="33%">
            </div>

            <form class="floating-labels m-t-40" action="{{Route('production.factory.store')}}" method="POST">
                @csrf
                <div class="row pt-4">
                   <div class="col-md-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="Text" name="factory_contact_number" class="form-control" placeholder="Factory Phone Number">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label"> Address:</label>
                            <div class="col-sm-9">
                                <textarea class="form-control" name="address" rows="4" placeholder="Factory Address"></textarea>
