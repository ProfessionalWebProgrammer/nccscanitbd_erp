            ...
            <div class="container-fluid">
                ...
                <div class="py-4">
                    <div class="text-center">
                        <h5 class="text-uppercase font-weight-bold">Warehouse List</h5>
                        <hr>
                    </div>
                            ...
                            @foreach($factorys as $data)
                                ...
                                <tr>
                                    ...
                                    <td class="text-center align-middle">
                                        <a class="btn btn-xs purchaseedit text-light" style="background-color: #66BB6A"
                                            href="{{ URL::to('warehouse/edit/' . $data->id) }}" data-toggle="tooltip"
