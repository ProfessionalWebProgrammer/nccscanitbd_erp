    ...
    <div class="content-wrapper">
        ...
        <div class="content px-4 ">
            <div class="container-fluid">
                ...
                <form class="floating-labels m-t-40" action="{{ Route('production.factory.update') }}"
                    method="POST">
                    @csrf
                    <div class="row pt-4">
                      <div class="col-md-3">
    <input type="hidden" name="id" value="{{$werehousedata->id}}" class="form-control" placeholder="Factory Name">
                       
                    </div>
                    <div class="col-md-6">
                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Factory Name :</label>
                            <div class="col-sm-9">
                                <input type="Text" name="factory_name" value="{{$werehousedata->factory_name}}" class="form-control" placeholder="Factory Name">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Phone Number:</label>
                            <div class="col-sm-9">
                                <input type="Text" name="factory_contact_number" value="{{$werehousedata->factory_contact_number}}" class="form-control" placeholder="Factory Phone Number">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label"> Address:</label>
                            <div class="col-sm-9">
                                <textarea class="form-control" name="address" rows="4" placeholder="Factory Address">{{$werehousedata->factory_address}}</textarea>
