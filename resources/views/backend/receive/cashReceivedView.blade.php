        ...
        <div class="content px-4 ">
            ...
            <div class="container-fluid" id="cardbody">
                ...
                <div class="text-center pt-3 mb-4">
                    <h5 class="text-uppercase font-weight-bold">Cash Received View</h5>
                   <hr>
                </div>
                <div class="row pt-5">
					    @php
                        ...
                        <table id="" class="table table-bordered table-striped table-fixed" style="font-size:20px;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle">{{ $data->wirehouse_name }}</td>
                                    <td></td>
                                ...
                                <tr>
                                    <td></td>
                                    <td class="align-middle">{{ $data->d_s_name }}</td>
                                    <td class="text-center align-middle">0/-</td>
                                    <td class="text-center align-middle"> {{ number_format($data->amount,2) }}/-</td>
                                </tr>
                            ...
                            @if(!empty($data->payment_description))
                                <tr>
                                    <td colspan="6" align="left" ><strong>Note:</strong> {{ $data->payment_description }}</td>
                                </tr>
                            @endif
                        	<tr>
                                <td colspan="6" align="left" ><strong>Total Amount:</strong> {{ convert_number($data->amount).convert_paisa((string)$data->amount) }}</td>
                            </tr>
                        </table>
                    </div>
                </div>
