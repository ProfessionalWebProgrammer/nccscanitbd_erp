        ...
        <div class="row">
            <div class="col-md-6" style="border-right: 2px solid black">
                ...
                <div class="content px-4 ">
                    ...
                    <form class="floating-labels " action="{{ route('lcLedger.store') }}" method="POST">
                        @csrf

                        <div class="container-fluid">
                            <div class="pt-2 text-center">
                                <h4 class="font-weight-bolder text-uppercase">L.C Ledger</h4>
                                <hr width="33%">
                            </div>
                            <div class="row pt-1">
                            <div class="form-group col-md-12">
                                    <label class=" col-form-label">Group Name :</label>
                                        <select class="form-control select2" required name="lcGroup_id"  >
                    ...
                    <div class="container-fluid">
                        <div class="py-4">
                            <div class="text-center">
                                <h5 class="text-uppercase font-weight-bold">L.C Ledger List</h5>
                                <hr>
                            </div>
    ...
    <div class="modal fade" id="delete">
            <div class="modal-dialog">
                <div class="modal-content bg-danger">
                    ...
                    <form action="{{route('lcLedger.delete')}}" method="POST">
                        {{ method_field('delete') }}
                        @csrf

                        <div class="modal-body">
                            <p>Are you sure to delete this LC Ledger?</p>
