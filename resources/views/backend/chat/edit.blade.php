...
<style media="screen">
  ...
  label{
                  ...
                  <div class="text-center">
                    ...
                    <p>Head office, Rajshahi, Bangladesh</p>
						...
						<div class="col-md-12 text-center">
							<h3>Materials Requisition Approved Form</h3>
						</div>
                        @php
	...
	{{--
			...
			<form class="floating-labels" action="{{route('user.chat.approved', $data->id)}}" method="POST">
          @csrf
            ...
            {{--  <input type="hidden" name="approved_user" value="{{$approvedUserId}}"> --}}
              <div class="col-md-12 mt-3">
                ...
                {{--  <div class="col-md-3">
                  <div class="form-check h6">
                  <input class="form-check-input" type="checkbox"  name="item[]" id="s2" value="2"  class="form-control present-checkbox" style="width: 20px; height: 20px;">
                    <label class="form-check-label" for="s2">New Development Product </label>
                  </div>
                  </div>
                  <div class="col-md-3">
                  <div class="form-check h6">
                  <input class="form-check-input" type="checkbox"  name="item[]" id="s3" value="3"  class="form-control present-checkbox" style="width: 20px; height: 20px;">
                    <label class="form-check-label" for="s3">Change The Address </label>
                  </div>
                  </div>
                  <div class="col-md-3">
                  <div class="form-check h6">
                  <input class="form-check-input" type="checkbox"  name="item[]" id="s4" value="4"  class="form-control present-checkbox" style="width: 20px; height: 20px;">
                    <label class="form-check-label" for="s4">Quality 100% Export </label>
                  </div>
                </div> --}}
                </div>
              	<div class="row pt-4">
