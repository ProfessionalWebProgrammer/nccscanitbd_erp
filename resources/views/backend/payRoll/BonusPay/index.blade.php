            ...
            <div class="container-fluid">
                <div class="pt-3">
                  <div class="col-md-12 text-right">
                      <a href="{{route('hrpayroll.employee.bonusPayment.create')}}" class="btn btn-sm btn-success">Bonus Payment Create</a>
                      <a href="{{route('hrpayroll.employee.holidayBonus.list')}}" class="btn btn-sm btn-success">Holiday Bonus</a>
                  </div>
                ...
                <div class="py-4 table-responsive">
                    <div class="text-center">
                        <h5 class="text-uppercase font-weight-bold">Employee Bonus Payment List</h5>
    ...
    <div class="modal fade" id="delete">
        <div class="modal-dialog">
            <div class="modal-content bg-danger">
                ...
                <form action="{{ route('hrpayroll.employee.bonusPayment.delete') }}" method="POST">
                    {{ method_field('delete') }}
                    @csrf
