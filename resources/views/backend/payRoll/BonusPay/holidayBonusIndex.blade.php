        ...
        <div class="row">
            <div class="col-md-6" style="border-right: 2px solid black">
                ...
                <div class="content px-4 ">
                    ...
                    <form class="floating-labels " action="{{ Route('hrpayroll.employee.holidayBonus.store') }}" method="POST">
                        @csrf

                        <div class="container-fluid">
                            <div class="pt-2 text-center">
                                <h4 class="font-weight-bolder text-uppercase">Employee Holiday Bonus Create</h4>
                                <hr width="33%">
                            </div>
                    ...
                    <div class="container-fluid">
                        <div class="py-4">
                            <div class="text-center">
                                <h5 class="text-uppercase font-weight-bold">Employee Holiday Bonus List</h5>
                                <hr>
                            </div>
    ...
    <div class="modal fade" id="delete">
            <div class="modal-dialog">
                <div class="modal-content bg-danger">
                    ...
                    <form action="{{route('hrpayroll.employee.holidayBonus.delete')}}" method="POST">
                        {{ method_field('delete') }}
                        @csrf
