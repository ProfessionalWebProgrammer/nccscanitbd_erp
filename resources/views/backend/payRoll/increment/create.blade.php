...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content px-4 ">
          <div class="container">
            <form action="{{route('hrpayroll.employee.increment.store')}}" method="POST">
                @csrf
                <input type="hidden" name="user_id" value="{{$urerid}}">
                    <div class="pt-3 text-center">
                        <h4 class="font-weight-bolder text-uppercase">Emploayee Increment Create </h4>
                        <hr width="33%">
                    </div>
                    <div class="row pt-4">
                      <div class="col-md-6">
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label"> Executive Month :</label>
                            <div class="col-sm-9">
                                <select name="month" class="form-control select2" id="">
                                    <option value="">== Select Executive Month ==</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" name="amount" class="form-control" value="" placeholder="Increment Amount">
                            </div>
                        </div>
                        </div>
