        ...
        <div class="content px-4">
            <div class="form container  ">
              <div class="row">
                  ...
                  <div class="col-md-12">
                    <form class="floating-labels pt-5" action="{{route('emp.worker.payslip.report')}}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="offset-md-2 col-md-4">
                                <div id="thisDate">
                                  ...
                                  <div class="input-group">
                                        ...
                                        <input type="text" name="date" class="form-control float-right" id="daterangepicker" style="border-radius: 0px 12px 12px 0px!important;" required>
                            ...
                            <div class="col-md-4" >
                                ...
                                data-live-search="true" data-actions-box="true"  name="employee" required>
