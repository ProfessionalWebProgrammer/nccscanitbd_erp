            ...
            <div class="container-fluid">
                <div class="pt-3">
                  <div class="col-md-12 text-right">
                      <a href="{{route('hrpayroll.employee.salaryAdvance.create')}}" class="btn btn-sm btn-success">Advance Salary Create</a>
                  </div>
                ...
                <div class="py-4 table-responsive">
                    <div class="text-center">
                        <h5 class="text-uppercase font-weight-bold">Employee Advance Salary List</h5>
    ...
    <div class="modal fade" id="delete">
        <div class="modal-dialog">
            <div class="modal-content bg-danger">
                ...
                <form action="{{ route('hrpayroll.employee.salaryAdvance.delete') }}" method="POST">
                    {{ method_field('delete') }}
                    @csrf
