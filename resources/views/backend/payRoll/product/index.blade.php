            ...
            <div class="container-fluid">
                <div class="pt-3">
                  <div class="col-md-12 text-right">
                      <a href="{{route('hrpayroll.employee.product.create')}}" class="btn btn-sm btn-success">Product Create</a>
                  </div>
    ...
    <div class="modal fade" id="delete">
        <div class="modal-dialog">
            <div class="modal-content bg-danger">
                ...
                <form action="{{ route('hrpayroll.employee.product.delete') }}" method="POST">
                    {{ method_field('delete') }}
                    @csrf
