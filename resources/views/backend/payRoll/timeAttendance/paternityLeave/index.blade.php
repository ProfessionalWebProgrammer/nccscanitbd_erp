            ...
            <div class="container-fluid">
                <div class="pt-3">
                  <div class="col-md-12 text-right">
                    <a href="{{route('hrpayroll.time.attendance.paternityLeavePolicy.create')}}" class="btn btn-sm btn-success">Employee Paternity Leave Policy Create </a>
                ...
                <div class="py-4 table-responsive">
                    <div class="text-center">
                      <h5 class="text-uppercase font-weight-bold">Employee Paternity Leave Policy List</h5>
                      <hr>
                    </div>
