...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content px-4 ">
          <div class="container">
            <form action="{{route('hrpayroll.time.attendance.employeeFractionalLeave.store')}}" method="POST">
                @csrf
                    <div class="pt-3 text-center">
                        <h4 class="font-weight-bolder text-uppercase">SL Leave Create </h4>
                        <hr width="33%">
                    </div>
                    <div class="row pt-4">
                     ...
                     <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                  <input type="text" name="sl_day" class="form-control">
                                </div>
                            </div>
                        </div>
                        <input type="hidden" name="cl_day" value="">
                        {{-- <div class="col-md-6">
                            <div class="form-group row">
