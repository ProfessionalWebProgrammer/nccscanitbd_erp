            ...
            <form action="#" method="POST">
                @csrf
                    ...
                    <div class="pt-3 text-center">
                        <h4 class="font-weight-bolder text-uppercase">Emploayee Arrear Payment Create </h4>
                        <hr width="33%">
                    </div>
                    <div class="row pt-4">
                      <div class="col-md-6">
                      ...
                      <div class="col-md-6">
                          <div class="form-group row">
                              <label class="col-sm-3 col-form-label">Arrear Date :</label>
                              <div class="col-sm-9">
                                  <input type="date" name="arrear_date" class="form-control" placeholder="Transfer Date">
                              </div>
                          </div>
                      </div>
                     <div class="col-md-6">
