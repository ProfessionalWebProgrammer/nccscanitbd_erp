...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content px-4 ">
          <div class="container">
            <form action="{{route('hrpayroll.employee.loan.store')}}" method="POST">
                @csrf
                <input type="hidden" name="user_id" value="{{$userId}}">
                    <div class="pt-3 text-center">
                        <h4 class="font-weight-bolder text-uppercase">Emploayee Loan Create </h4>
                        <hr width="33%">
                    </div>
                    <div class="row pt-4">
                      <div class="col-md-6">
