            ...
            <div class="container-fluid">
                <div class="pt-3">
                  <div class="col-md-12 text-right">
                      <a href="{{route('hrpayroll.employee.reimbursementPayment.create')}}" class="btn btn-sm btn-success">Reimbursement Payment Create</a>
                  </div>
                ...
                <div class="py-4 table-responsive">
                    <div class="text-center">
                        <h5 class="text-uppercase font-weight-bold">Employee Reimbursement Payment List</h5>
