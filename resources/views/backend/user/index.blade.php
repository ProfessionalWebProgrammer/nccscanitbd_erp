                                ...
                                <tr>
                                    ...
                                    <td class="text-center align-middle">
                                        {{-- <a class="btn btn-sm"
                                            ...
                                            href="#"
                                            data-toggle="tooltip" data-placement="top" title="CheckOut Return Invoice"><i
                                                class="fas fa-spinner"></i></a> --}}
                                        @if (Auth::id() == 101)
                                            @if ( $data->id == 101)
                                            <a class="btn btn-sm btn-primary " href="{{route('user.setting.set.permission',$data->id)}}" data-toggle="tooltip"
                                            data-placement="top" title="Set Permission">Set Permission</i> </a>
                                            @else
                                            <a class="btn btn-sm btn-primary "  href="{{route('user.setting.set.permission',$data->id)}}" data-toggle="tooltip"
                                            data-placement="top" title="Set Permission">Set Permission</i> </a>
                                        <a class="btn btn-sm btn-danger " href="" data-toggle="modal"
                                            data-target="#delete" data-myid="{{ $data->id }}"><i
