                ...
                <div class="col-md-12 mt-5">
                  <div class="text-center">
                    ...
                    <p>Head office, Rajshahi, Bangladesh</p>
                		...
                		$users = DB::table('requisition_users')->select('employees.emp_name')->leftJoin('employees', 'employees.user_id', '=', 'requisition_users.to_user_id')->where('requisition_id',$data->id)->get();
										...
										<div class="col-md-6">
											<div class="text-left">
												...
												<span>Name: @foreach($users as $user)
                                                  ...
                                                  @endphp
                                                  {{$user->emp_name ?? ' Admin'}}  ,  @endforeach</span></br>
                ...
                <div class="py-2 ">
                    <table class="table" style="font-size: 16px;">
                        ...
                        <tbody style="font-size: 16px;">
                          @php
                          $all = DB::table('requisition_details')
                                        ->where('req_id', $data->id)
                                        ->get();
                          @endphp
													@foreach($all as $key => $val)
													@php
													$item = DB::table('row_materials_products')->where('id',$val->item)->first();
