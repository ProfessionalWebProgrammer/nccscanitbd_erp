...
@section('content')
    ...
    <div class="content-wrapper posclass">
        ...
        <div class="content px-4 ">
            ...
            <form action="{{route('production.packing.consumption.update',$packingConsumption->id)}}" method="post">
                @csrf
                    ...
                    <div class="row pt-4">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="date" value="{{ $packingConsumption->date }}" class="form-control" name="date">
                            </div>
                        </div>
                      <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <select class="form-control select2 product_id" name="pro_invoice"
                                  ...
                                  @foreach ($invoices as $val)
                                    <option value="{{ $val->invoice }}" @if($packingConsumption->pro_invoice == $val->invoice) selected @else  @endif>{{ $val->invoice }}</option>
                                @endforeach
                                </select>
                            </div>
                        </div>
                       ...
                       <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="note" value="{{$packingConsumption->note}}">
                            </div>
                        </div>
                    </div>
                                                ...
                                                <div class="col-md-5">
                                                    <select class="form-control select2 product_id" name="product_id[]"
                                                      ...
                                                      @foreach ($finishedgoods as $item)
                                                        <option value="{{ $item->id }}" {{$packingConsumption->product_id == $item->id ? 'selected' :''}}>{{ $item->product_name }}</option>
                                                    @endforeach
                                                    </select>
                                                </div>
                                              <div class="col-md-5">
                                                    <select class="form-control select2 product_id" name="bag_id[]"
                                                        data-live-search-style="startsWith" required>
                                                        <option value=" " selectedS>Select Bag Type</option>
                                                      
                                                      @foreach ($purchases as $val)
                                                     
                                                        <option value="{{ $val->id }}" {{$packingConsumption->bag_id == $val->id ? 'selected' :''}}>{{ $val->product_name }}</option>
                                                    @endforeach
                                                    </select>
                                                </div>
                                                <div class="col-md-2">
                                                   <input type="text" class="form-control p_qty" name="qty[]" placeholder="Quantity" value="{{$packingConsumption->qty}}">
