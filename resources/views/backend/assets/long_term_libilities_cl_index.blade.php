        ...
        <div class="content px-4 ">
          <div class="row pt-2">
                  	<div class="col-md-12 text-left">
                        <a href="{{ URL('/asset/long/term/libilities/create') }}" class=" btn btn-success btn-sm mr-2 mt-1">Create New Client</a>
                    </div>
                </div>
            <div class="container-fluid">
                <div class="text-center pt-3">
                    ...
                    <h5>Long Term Libilities Client List</h5>
                </div>
                <div class="py-4">
    ...
    <div class="modal fade" id="delete">
            <div class="modal-dialog">
                <div class="modal-content bg-danger">
                    ...
                    <form action="{{ route('asset.long.term.libilities.delete') }}" method="POST">
                        {{ method_field('delete') }}
                        @csrf
