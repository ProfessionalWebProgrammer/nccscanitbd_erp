        ...
        <div class="content px-4 ">
          <div class="row pt-2">
                  	<div class="col-md-12 text-right">
                          <a href="{{ URL('asset/clint/create') }}" class=" btn btn-success btn-sm mr-2 mt-1">Create New Client</a>
                    </div>
                </div>
    ...
    <div class="modal fade" id="delete">
            <div class="modal-dialog">
                <div class="modal-content bg-danger">
                    ...
                    <form action="{{ route('asset.clint.delete') }}" method="POST">
                        {{ method_field('delete') }}
                        @csrf
