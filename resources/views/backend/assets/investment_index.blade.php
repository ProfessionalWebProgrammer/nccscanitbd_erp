    ...
    <div class="content-wrapper accountscontent">
        ...
        <div class="content px-4 ">
           <li class="nav-item d-none d-sm-inline-block">
              <a href="{{ URL('asset/investment/create') }}" class=" btn btn-success btn-sm mr-2 mt-1">Create New
                  </a>
          </li>
                        ...
                        <tbody style="font-size: 18px;">
                            ...
                            @foreach ($stlcdata as $data)
                                <tr>
                                    ...
                                    <td class="text-center">{{ $data->asset_qty }}</td>
                                    <td class="text-center">{{ $data->asset_unit_price }}</td>
    ...
    <div class="modal fade" id="delete">
            <div class="modal-dialog">
                <div class="modal-content bg-danger">
                    ...
                    <form action="{{ route('asset.investment.delete') }}" method="POST">
                        {{ method_field('delete') }}
                        @csrf
