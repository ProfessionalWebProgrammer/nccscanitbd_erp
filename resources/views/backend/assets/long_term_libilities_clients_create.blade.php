            ...
            <div class="container-fluid">
                <div class="row" style="min-height: 85vh">
                    <div class="col-md-10 mx-auto">
                        <form class="floating-labels m-t-40" action="{{ route('asset.long.term.libilities.store') }}"
                            method="POST">
                            @csrf
                            <div class="pt-4 text-center">
                                <h4 class="font-weight-bolder text-uppercase">Create Long Term Libilities Client </h4>
                                <hr width="33%">
                            </div>
