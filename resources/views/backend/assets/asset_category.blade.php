            ...
            <div class="row" style="min-height: 85vh">
                <div class="col-md-4" style="border-right: solid #003B46">
                    <div class="container-fluid">
                        <form class="floating-labels m-t-40" action="{{ route('store.asset.category') }}" method="POST">
                            @csrf
                                <div class="pt-4 text-center">
                                    <h4 class="font-weight-bolder text-uppercase">Create Asset Category</h4>
                                    <hr width="33%">
                                </div>
                                ...
                                <div class="row pt-3">
                                    ...
                                    <div class="form-group col-md-12">
                                        <label class=" col-form-label">Asset Category Description :</label>
                ...
                <div class="col-md-8">
                    <div class="container-fluid">
                        <div class="py-4">
                            <div class="text-center">
                                <h3 class="text-uppercase font-weight-bold">Asset Category List</h3>
                                <hr>
                            </div>
    ...
    <div class="modal fade" id="delete">
        <div class="modal-dialog">
            <div class="modal-content bg-danger">
                ...
                <form action="{{ route('delete.asset.category') }}" method="POST">
                    {{ method_field('delete') }}
                    @csrf
