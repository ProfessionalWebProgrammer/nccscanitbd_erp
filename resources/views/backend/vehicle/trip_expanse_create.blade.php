...
@section('content')
    ...
    <div class="content-wrapper posclass">
        ...
        <div class="content px-4 pt-3">
            <form action="{{route('trip.expanse.store')}}" method="post">
                @csrf
                <div class="container-fluid">
                    <h3 class="text-center">Trip Expanse Create</h3> <hr>
                    <div class="row pt-4">
                     
                       <div class="col-md-6">
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-3 col-form-label">Trip Invoice: </label>
                                <div class="col-sm-9">
                                  	<input type="text"  class="form-control" name="invoice" value="{{$trips->invoice}}" readonly>
                                </div>
                            </div>
                         </div> 
                      <div class="col-md-6">
                      <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-3 col-form-label">Expanse Group: </label>
                                <div class="col-sm-9">
                                     <select class="form-control select2" required name="expanse_group_id" >
                                        <option value="">Select Expanse Group </option>
                                        @foreach ($expanse_groups as $data)
                      ...
                      <div class="col-md-6">   
                           <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                  	<input type="hidden"  class="form-control" value="{{$trips->driver_id}}"  name="driver_id">
                                    <input type="text"  class="form-control" value="{{$trips->driver_name}}" readonly>
                                </div>
                            </div>
                        </div>
                  		<div class="col-md-6">   
                           <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                   <input type="text"  class="form-control" value="{{$trips->vehicle_number}}" readonly>
                                </div>
                            </div>                        
                        </div>
                  		<div class="col-md-6">   
                           <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-3 col-form-label">Trip Income: </label>
                                <div class="col-sm-9">
                                   <input type="text"  class="form-control" value="{{$trips->trip_value}}" readonly>
                                </div>
                            </div>                        
                        </div>
