                ...
                <div class="tab-content" id="myTabContent">
                  <div class="tab-pane fade show active" id="receive" role="tabpanel" aria-labelledby="profile-tab">
                   <div class="py-4 table-responsive">
                        ...
                        <table id="example3" class="table table-bordered table-striped table-fixed" style="font-size: 12px;">
                            <thead>
                            ...
                            <tbody style="font-size: 12px;">
                              ...
                              <tr>
                                ...
                                <!-- <td>{{$item->amount}}</td> -->
                                <td><a href="{{URL::to('/public/uploads/requisition/')}}/{{$item->doc}}" target="_blank" download>{{$item->doc}}</a> </td>
                                ...
                                <td>@if($item->status == 3  && $userId == $myid) <span class="btn btn-success btn-xs" data-toggle="tooltip" data-placement="top" title="PR Approved Accept"><i class="fa fa-check-circle" aria-hidden="true"></i></span> @elseif($item->status == 4) <span class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="top" title="PR Approved Reject"> <i class="fa fa-times" aria-hidden="true"></i> </span> @else {{$item->status == 0 ? "UnRead" : "Seen"}}
                                  @endif</td>
                                <td>@if($item->status == 3 || $status == 3 && $userId == $myid)<a href="{{route('user.multiFunction.requisition.view',$item->id)}}" class="btn btn-primary btn-xs" data-toggle="tooltip" data-placement="top" title="Requisition View"><span
                                                class="fa fa-eye"></span></a>  @elseif(!empty($userId)) <a href="{{route('user.multiFunction.requisition.edit',[$item->id,$userId])}}" class="btn btn-info btn-xs" data-toggle="tooltip" data-placement="top" title="Requisition Approved Pending"><span
                                                class="fa fa-spinner"></span></a>  @elseif($myid == 101)  <a href="{{route('user.multiFunction.requisition.edit',[$item->id,101])}}" class="btn btn-info btn-xs" data-toggle="tooltip" data-placement="top" title="Requisition Approved Pending"><span
                  ...
                  <div class="tab-pane fade" id="sentm"  role="tabpanel" aria-labelledby="home-tab">
                    ...
                    <div class="py-4 table-responsive">
                        ...
                        <table id="example5" class="table table-bordered table-striped table-fixed" style="font-size: 12px;">
                            <thead>
                                <tr class="text-center table-header-fixt-top">
                                    <th>Sl</th>
                                    <th>Date</th>
                            ...
                            <tbody style="font-size: 12px;">
                             ...
                             @foreach($from as $item)
                              ...
                              <tr>
                                <td>{{$loop->iteration}}</td>
                                <td>{{date('d-m-Y', strtotime($item->date))}}</td>
                                <td>{{$fuser}} {{date('d M y, g:i a', strtotime($item->created_at));}}</td>
                                <td>{{$item->reference}}</td>
                                <td>{{$item->invoice}}</td>
                                <td>{{$item->supplier->supplier_name}}</td>
                                <!-- <td>{{$item->amount}}</td> -->
                                ...
                                <td>@if($item->status == 3 && $approvedUserId == $myid)<a href="{{route('user.multiFunction.requisition.view',$item->id)}}" class="btn btn-primary btn-xs" data-toggle="tooltip" data-placement="top" title="PR View"><span
                                                class="fa fa-eye"></span></a>  @elseif(!empty($approvedUserId)) <a href="{{route('user.multiFunction.requisition.edit',[$item->id,$approvedUserId])}}" class="btn btn-info btn-xs" data-toggle="tooltip" data-placement="top" title="PR Approved"><span
                                                class="fa fa-spinner"></span></a>  @elseif($myid == 101)  <a href="{{route('user.multiFunction.requisition.edit',[$item->id,101])}}" class="btn btn-info btn-xs" data-toggle="tooltip" data-placement="top" title="PR Approved Pending"><span
                                                class="fa fa-spinner"></span></a>@elseif($item->from_user == $myid || $myid == 101)
                                  <a href="{{route('user.multiFunction.requisition.again.edit',$item->id)}}" class="btn btn-primary btn-xs" data-toggle="tooltip" data-placement="top" title="PR Edit"><span
