                      ...
                      <div class="col-md-12 row">
                        <div class="col-md-4">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="amount" class="form-control" placeholder="Anount">
                            </div>
                        ...
                        <div class="col-md-8">
                          <div class="form-group row">
                              ...
                              <div class="col-sm-10">
                                  <textarea name="description" class="form-control" required  rows="4" placeholder="Note"></textarea>
                              </div>
                          </div>
                      </div>
