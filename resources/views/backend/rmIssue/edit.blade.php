...
<style media="screen">
    ...
    <div class="content-wrapper">
        ...
        <form class="floating-labels m-t-40" action="{{route('row.materials.issuesEditUpdate', $rawData->id)}}" method="POST">
            @csrf
        ...
        <div class="content px-4 ">
            <div class="container" style="background:#ffffff; padding:0px 40px;min-height:85vh">
                <div class="pt-3 text-center">
                    <h4 class="font-weight-bolder text-uppercase text-danger">Raw Materials Issue Edit</h4>
                    <hr width="33%">
                </div>
              <div class="row pt-3">
                      <div class="col-md-12">
                              ...
                              <div class="col-md-4">
                                  <div class="form-group row">
                                      <label class=" col-form-label col-md-4">Date:</label>
                                       <input type="date" name="date" value="{{ $rawData->date }}" class="form-control col-md-8">
                                   </div>
                               </div>
                            {{-- <div class="col-md-3">
                                  <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                  <div class="form-group row">
                                      <label class=" col-form-label col-md-4">Issued By:</label>
                                    	<input type="text" name="issued_by" class="form-control col-md-8" value="{{$rawData->issued_by}}">
                                   </div>
                               </div> 
                                                        ...
                                                        <div class="row">
                                                                    ...
                                                                    <select name="product_id[]" class="form-control select2 orderProduct" required>
                                                                        <option value="">== Select Product ==</option>
                                                                                @foreach ($data as $item)
                                                                                    <option value="{{ $item->id }}" @if($rawData->product_id == $item->id) selected  @else  @endif>{{ $item->product_name }}</option>
                                                                                @endforeach
                                                                    </select>
                                                                </div>
                                                            </div>
                                                          <div class="col-md-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="unit[]"  class="form-control orderUnit" value="{{$rawData->unit}}" readonly>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                   <label class=" col-form-label"> Quantity:</label>
                                                                    <input type="text"  name="quantity[]" value="{{$rawData->qty}}" class="form-control qty" >
                                                                  	<input type="hidden" name="id[]" value="{{$rawData->id}}">
                                                                </div>
                                                            </div>
                      ...
                      <div class="col-md-3">
                      	...
                      	<div class="col-md-6">
                        	<div class="form-group row">
                              ...
                              <div class="col-sm-10">
                                <textarea name="note" rows="3" cols="40%">{{ $rawData->note }}</textarea>
                              </div>
                        	</div>
                        </div>
                    </div>
