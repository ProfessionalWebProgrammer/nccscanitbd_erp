                        ...
                        <table id="reporttable" class="table table-bordered table-striped table-fixed"
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td align="right">{{number_format(130017306, 2)}}</td>
                            </tr>
                            <tr>
                              <td>Sales Discount</td>
                              <td align="right">{{number_format(2529056, 2)}}</td>
                            </tr>
                            <tr>
                              <td>Sales by Dealer (30.60%)</td>
                              <td align="right">{{number_format(32909853, 2)}}</td>
                            </tr>
                            <tr>
                              <td>Sales to Naba Farm (69.40%) </td>
                              <td align="right">{{number_format(97107453, 2)}}</td>
                            </tr>
                            <tr>
                              <td>Total Sales Revenues :</td>
                              <td align="right">{{number_format((127212135), 2)}}</td>
                            </tr>
                            </tbody>
                    </table>
                    </div>
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <tr>
                                    ...
                                    <td align="right">{{ number_format(119866547, 2) }}</td>

                                </tr>
                                <tr style="font-weight: bold">
                                    <td>Gross profit</td>
                                    <td align="right">{{ number_format($total, 2) }} @if($total != 0)({{  number_format(($total/127212135)*100,2) }}%) @endif</td>
                  ...
                  <div class="py-4 col-md-4 table-responsive">
                        <table id="reporttable" class="table table-bordered table-striped table-fixed"
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td align="right">{{number_format(102350863, 2)}}</td>
                            </tr>
                            <tr>
                              <td>Medicine Consumption</td>
                              <td align="right">{{number_format(8422226, 2)}}</td>
                            </tr>
                            <tr>
                              <td>Packing Material Consumption</td>
                              <td align="right">{{number_format(1374375, 2)}}</td>
                            </tr>
                            <tr>
                              <td>Labor Expenses (Direct)</td>
                              <td align="right">{{number_format(1449927, 2)}}</td>
                            </tr>
                            <tr>
                              <td>Total C O G S :</td>
                              <td align="right">{{number_format((1449927 + 1374375 + 8422226 + 102350863), 2)}}</td>
                            </tr>
                            </tbody>
                    </table>
                        ...
                        <table id="reporttable" class="mt-5 table table-bordered table-striped table-fixed"
                          ...
                          <tbody>
                            ...
                            <tr>
                              <td>Salary -mgt	   </td>
                              <td align="right">{{number_format(982816, 2)}}</td>
                            </tr>
                            <tr>
                              <td>Salary-Casual	  </td>
                            ...
                            <tr>
                              ...
                              <td align="right">{{number_format((982816 + 65500 + 90091 + 6004 + 2228000 + 942143 + 400000 + 203190 + 153197+643058+26092+100000+ 259270+4950+112000 + 3897 + 3740 + 25632 + 9700+2660), 2)}}</td>
                            </tr>
                            </tbody>
                    </table>
                  </div>
