    ...
    <div class="content px-4 ">
        <div class="container-fluid">
            <div class="pt-3 text-center">
                <h4 class="font-weight-bolder text-uppercase">Lease Entry</h4>
                <hr width="33%">
            </div>

            <form class="floating-labels m-t-40" action="{{Route('lease.store')}}" method="POST">
                @csrf
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-lg-3">
                                 ...
                                 {{--  <div class="col-md-4">
                                   ...
                                   <div class="col-lg-5 mr-2">
                                       <div class=" form-group row">
                                           <label class=" col-form-label">Head:</label>
                                              <input type="Text" name="head" class="form-control" placeholder=" " required>
                                    ...
                                    <div class="col-lg-3 mr-2">
                                       <div class=" form-group row">
                                           <label class=" col-form-label">Lease Amount:</label>
                                   ...
                                   <div class="col-lg-3 mr-2">
                                       <div class=" form-group row">
                                           <label class=" col-form-label">Lease Duration:</label>
