    ...
    <div class="content px-4 ">
        <div class="container-fluid">
            <div class="pt-3 text-center">
                <h4 class="font-weight-bolder text-uppercase">Cash Create</h4>
                <hr width="33%">
            </div>

            <form class="floating-labels m-t-40" action="{{Route('master.cash.store')}}" method="POST">
                @csrf
                <div class="row pt-4">
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="Text" name="wirehouse_name" class="form-control" placeholder=" Name">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="Text" name="wirehouse_opb" class="form-control" placeholder="Opening Balacen">
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">  
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" name="wirehouse_address" rows="3" placeholder=" Address"></textarea>
