    ...
    <div class="content px-4 ">
        <div class="container-fluid">
            <div class="pt-3 text-center">
                <h4 class="font-weight-bolder text-uppercase">Borrow Entry</h4>
                <hr width="33%">
            </div>

            <form class="floating-labels m-t-40" action="{{Route('loan.borrowing.store')}}" method="POST">
                @csrf
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-lg-3">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class=" col-form-label">Borrow Type:</label>
                                   ...
                                   <div class="col-lg-5 mr-2">
                                       <div class=" form-group row">
                                           <label class=" col-form-label"> Client:</label>
                                             <select name="from_client_id" class="form-control select2">
                                                <option value="">== Select client ==</option>
                                                @foreach ($ascs as $data)
                                  ...
                                  <div class="col-lg-1 mr-2">To</div>
                                  
                                   <div class="col-lg-5 mr-2">
                                       <div class=" form-group row">
                                           <label class=" col-form-label">Company:</label>
                                              <select name="to_company_id" class="form-control select2">
                                                <option value="">== Select client ==</option>
                                  ...
                                  <div class="col-lg-5 mr-2">
                                       <div class=" form-group row">
                                           <label class=" col-form-label"> Comapy:</label>
                                             <select name="from_company_id" class="form-control select2">
                                                <option value="">== Select client ==</option>
                                                @foreach ($companys as $data)
                                                    <option value="{{ $data->id }}">
                                                        {{ $data->name }}</option>
                                  ...
                                  <div class="col-lg-1 mr-2">To</div>
                                   ...
                                   <div class="col-lg-5 mr-2">
                                       <div class=" form-group row">
                                           <label class=" col-form-label">Client:</label>
                                               <select name="to_client_id" class="form-control select2">
                                                <option value="">== Select client ==</option>
                                                @foreach ($ascs as $data)
                                                    <option value="{{ $data->id }}">
                                                        {{ $data->name }}</option>
                                    ...
                                    <div class="col-lg-4 mr-2">
                                       <div class=" form-group row">
                                           <label class=" col-form-label">Borrow Amount:</label>
                                    ...
                                    <div class="col-lg-4 mr-2">
                                       <div class=" form-group row">
                                           <label class=" col-form-label">Borrow  Deadline:</label>
