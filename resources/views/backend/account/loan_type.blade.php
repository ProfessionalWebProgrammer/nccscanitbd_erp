        ...
        <div class="content px-4 ">
            ...
            <div class="row">
                <div class="col-md-6" style="border-right: 2px solid black">
                    ...
                    <form class="floating-labels m-t-40" action="{{ Route('loan.type.store') }}" method="POST">
                        @csrf

                        <div class="container-fluid">
                            <div class="pt-3 text-center">
                                <h4 class="font-weight-bolder text-uppercase">Create Loan Type</h4>
                                <hr width="33%">
                            </div>
    ...
    <div class="modal fade" id="delete">
        <div class="modal-dialog">
            <div class="modal-content bg-danger">
                ...
                <form action="{{ route('loan.type.delete') }}" method="POST">
                    {{ method_field('delete') }}
                    @csrf
