...
@section('header_menu')
 <li class="nav-item d-none d-sm-inline-block pt-2">
              <a href="{{ route('loan.borrowing.create') }}" class=" btn btn-xs btn-success mr-2">Borrow Entry</a>
          </li>
@endsection
            ...
            <div class="container-fluid">
                ...
                <div class="py-4">
                    <div class="text-center">
                        <h5 class="text-uppercase font-weight-bold">Borrow List</h5>
                        <hr>
                    </div>
    ...
    <div class="modal fade" id="delete">
            <div class="modal-dialog">
                <div class="modal-content bg-danger">
                    ...
                    <form action="{{route('loan.borrowing.delete')}}" method="POST">
                        {{ method_field('delete') }}
                        @csrf
