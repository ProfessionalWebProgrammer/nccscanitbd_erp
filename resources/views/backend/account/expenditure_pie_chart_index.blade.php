        ...
        <div class="content px-4 ">
            <div class="container-fluid">
                ...
                <div class="text-center pt-3">
                    <h5 class="text-uppercase font-weight-bold"> Expenditure Pie Chart Input</h5>
                    <hr>
                </div>


                <div class="form">
                    <form class="floating-labels m-t-40" action="{{ Route('expenditure.pie.chart.report') }}" method="POST">
                        @csrf
                        <div class="row">
