          ...
          <div class="row pt-2">
            ...
            <div class="container-fluid">
               <div class="row pt-2">
                      ...
                      <h5 class="text-uppercase font-weight-bold">Budget Pie Chart</h5>
                      <p>{{$month_name}}</p>
...
var chart = new CanvasJS.Chart("chartContainer", {
	...
	title: {
		text: "Budget Pie Chart Graph - Total Budget {{$data['budget_total_amount']}}"
	},
	data: [{
		type: "pie",
		startAngle: 25,
    ...
    //  dd($totalparchent);
          ...
          @foreach($data['budget_amount'] as $item)
			{ y: {{$item->budgetamount}}, label: "{{$item->zone_title}}" },
    	@endforeach
		{ y: {{$data['budget_total_amount']-$data['budget_ditribute_amount']}}, label: "Budget NOT USED" }
		]
	}]
});
chart.render();
