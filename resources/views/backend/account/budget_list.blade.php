                        ...
                        <tbody>
                            ...
                            @foreach ($datas as $data)
                                <tr>
                                   ...
                                   <td >{{ $data->company }}</td>
                                    <td class="text-right">{{ $data->budget_amount }}</td>
                                    <td class="text-right">{{ $data->budget_year }}</td>
                                    ...
                                    <td class="text-center align-middle">
                                      ...
                                      <a class="btn btn-xs "
                                            style="background-color: mediumaquamarine;                                                                                                                                                                                                                                                                    color: white;"
                                            href="{{route('budget.distribution.create',$data->id)}}" data-toggle="tooltip" data-placement="top" title="Distribution">Distribution</a>
                                       <a class="btn btn-xs btn-warning accountsedit" href="{{route('budget.distribution.index',$data->id)}}" data-toggle="tooltip" data-placement="top" title="Distribution List">Distribution List</a>
