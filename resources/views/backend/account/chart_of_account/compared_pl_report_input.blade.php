...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content px-4 ">
            <div class="container-fluid">
                ...
                <div class="text-center pt-3">
                    <h5 class="text-uppercase font-weight-bold">Compared Income Statement Report Input</h5>
        ...
        <a  href="#normal" class="btn btn-sm btn-primary" data-toggle="tab">Normal Method </a>
          ...
          {{-- Normal Method start  --}}
                <div class="form mt-3">
                    <form class="floating-labels m-t-40" action="{{ route('compared.income.statement.report') }}" method="GET">
