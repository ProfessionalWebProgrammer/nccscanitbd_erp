        ...
        <div class="content px-4 ">
            <div class="container">
                ...
                <div class="text-center pt-3">
                    <h5 class="text-uppercase font-weight-bold">Cash Receivable Report</h5>
                    <hr>
                </div>


                <div class="form">
                    <form class="floating-labels m-t-40" action="{{ Route('cash.receivable.report.view') }}" method="POST">
                        @csrf
