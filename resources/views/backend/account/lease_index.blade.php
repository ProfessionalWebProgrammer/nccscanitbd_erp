    ...
    <div class="content-wrapper  accountscontent">
        ...
        <div class="content px-4 ">
          <li class="pt-2 nav-item d-none d-sm-inline-block">
              <a href="{{ route('lease.create') }}" class=" btn btn-success mr-2">Lease Entry</a>
          </li>
            <div class="container-fluid">
                ...
                <div class="py-4">
                    <div class="text-center">
                        <h5 class="text-uppercase font-weight-bold">Lease List</h5>
                        <hr>
                    </div>
    ...
    <div class="modal fade" id="delete">
            <div class="modal-dialog">
                <div class="modal-content bg-danger">
                    ...
                    <form action="{{route('lease.delete')}}" method="POST">
                        {{ method_field('delete') }}
                        @csrf
