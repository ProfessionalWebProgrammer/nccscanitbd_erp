        ...
        <div class="content px-4 ">
            <div class="row">
                <div class="col-md-6" style="border-right: 2px solid black">
                    <form class="floating-labels m-t-40" action="{{ Route('financialExpense.store') }}" method="POST">
                        @csrf

                        <div class="container-fluid">
                            <div class="pt-3 text-center">
                                <h4 class="font-weight-bolder text-uppercase">Financial Expense Create</h4>
                                <hr width="33%">
                            </div>
                            ...
                            <div class="row pt-4">
                                ...
                                <div class="form-group col-md-12">
                                    <label class="col-form-label">Financial Expense :</label>
                                    <input type="text" name="expense" class="form-control" placeholder="Financial Expense Amount">
                                </div>
                                <div class="form-group col-md-12">
    ...
    <div class="modal fade" id="delete">
        <div class="modal-dialog">
            <div class="modal-content bg-danger">
                ...
                <form action="{{ route('financialExpense.delete') }}" method="POST">
                    {{ method_field('delete') }}
                    @csrf
