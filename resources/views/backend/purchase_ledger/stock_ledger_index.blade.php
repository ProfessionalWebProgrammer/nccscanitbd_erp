        ...
        <div class="content px-4 ">
            ...
            <div class="container" style="background:#ffffff; padding:0px 40px;min-height:85vh">
                ...
                <div class="text-center pt-3">
                    <h3 class="text-uppercase font-weight-bold">Purchase Stock Ledger Input</h3>
                    <hr>
                </div>


                <div class="form">
                    <form class="floating-labels m-t-40" action="{{ Route('purchase.stock.ledger.report') }}" method="POST">
                        @csrf
                        ...
                        <div class="class row mt-5">
                            ...
                            <div class="class col-md-4 px-5">
                                <button type="submit" class="btn btn-info" style="width: 100%;">Generate Ledger</button>
                            </div>
