                    ...
                    <div class="text-center pt-3" style=" margin-bottom:10px; border:2px solid #000;">
                        ...
                        <table class="table table-bordered p-2" style="font-size: 11px;font-weight: 600; border:2px solid; ">
                            ...
                            <tbody style="font-size: 11px;">
                                ...
                                @if($key != 0)
                                <tr style="font-size: 11px;color:#17a50d; font-weight:bold;border-bottom:2px solid;">
                                ...
                                <tr style="font-size: 11px;color:#fff; font-weight:bold;border-bottom:2px solid;background-color:#c641cf;">
                              ...
                              @foreach($dealer_id as $val) 
                              @php 
                              $dealers = DB::table('dealers')->select('d_s_name','dlr_base')->where('id', $val)->first();
                              $gt_cb += $dealers->dlr_base;
                              @endphp 
                               {{-- <tr style="padding-right:15px;">	
                                	<td align="left">{{$dealers->d_s_name}}</td>
                                    <td colspan="90%" align="right" >{{number_format($dealers->dlr_base,2)}}</td>
                                </tr> --}}
                              
                              <tr style="font-size: 12px; font-weight:bold; ">
                                    <td colspan="6"><a href="{{url('/deler/index')}}?vendor_id={{$val}}" target="_blank"  style="color:red !important;"> {{ $dealers->d_s_name }}</a>  </td>
                                    <td colspan="3">Opening Balance</td>
                                    <td class="text-right">{{ number_format($dealers->dlr_base, 2) }} </td>
                                </tr>
                              ...
                              @endforeach 
                               @endif 
                                ...
                                <tr style="font-size: 12px; font-weight:bold; border-top:2px solid;">
