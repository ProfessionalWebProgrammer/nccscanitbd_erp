                    ...
                    <div class="text-center pt-3" style=" margin-bottom:10px;">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-4 text-left align-middle pl-3">
                              	<h5 style="font-weight: 800;">Production Bag COGS Ledger Report</h5>
                            ...
                            <tbody >
                                ...
                                @foreach ($invoices as $val)
                                  @php
                                    ...
                                    $preData =  App\Models\Account\ChartOfAccounts::select('date','invoice','debit','credit')->where('invoice',$val->invoice)->where('ac_sub_sub_account_id',163)->whereBetween('date', [$sdate, $preday])->first();
                                    $data =  App\Models\Account\ChartOfAccounts::select('date','invoice','debit','credit')->where('invoice',$val->invoice)->where('ac_sub_sub_account_id',163)->whereBetween('date', [$fdate, $tdate])->first();
