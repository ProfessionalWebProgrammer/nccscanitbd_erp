                ...
                <div class="table-responsive tableFixHead pb-5  pr-2 " id="reporttable">
                    <div class="text-center pt-3" style=" margin-bottom:10px; border:2px solid #000;">
                       ...
                       $datas = \App\Models\SalesLedger::where('vendor_id',$data->id)->whereBetween('ledger_date' ,[$fdate,$tdate])
                            ...
                            <div class="col-md-6">
                              <table class="table table-bordered p-2" style="font-size: 13px;font-weight: 600; border:2px solid; ">
                                  ...
                                  <tbody>
                                    <tr>
                                      <td>Total Sales </td>
                                      <td>@if($type == 'TB') {{number_format(($discount[0]->total_debit + $salesRevenueOB + $discount[0]->total_discount), 2)}} @else  {{number_format(($discount[0]->total_debit + $discount[0]->total_discount), 2)}}  @endif</td>
                                    </tr>
                                    <tr>
                              ...
                              <table class="table table-bordered p-2" style="font-size: 13px;font-weight: 600; border:2px solid; ">
                                  ...
                                  <tbody>
                                    <tr>
                                      ...
                                      <td>@if($type == 'TB'){{number_format(($totalSalesReturnAmount + $salesReturnOB), 2)}} @else {{number_format(($totalSalesReturnAmount), 2)}}  @endif </td>
                                    </tr>
                                    <tr>
                            ...
                            <div class="col-md-5">
                              <table class="table table-bordered p-2" style="font-size: 13px;font-weight: 600; border:2px solid; ">
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      <td colspan="3">Total Accounts Receivable (Dealer) </td>
                                      <td>{{ number_format($gt_cb,2) }}</td>
                                    </tr>
                                  </tbody>
                                </table>
                            </div>
                        ...
                        <div class="col-md-12">
                          <h5>Dealer Short Summary</h5>
                          <div class="row">
                            <div class="col-md-6" style="background: #FA621C">
                              <div class="row ">
                        ...
                        <table class="table table-bordered p-2" style="font-size: 11px;font-weight: 600; border:2px solid; ">
                            ...
                            <tbody style="font-size: 11px;">
                              ...
                              $totalCashCollection = \App\Models\Payment::where('payment_type','RECEIVE')
                                                      ...
                                                      ->whereBetween('payment_date',[$fdate,$tdate])->where('status',1)
                                                      ->sum('amount');
                              $totalBankCollection = \App\Models\Payment::where('payment_type','RECEIVE')
                                                      ->where('type','BANK')
                                                      ->where('invoice','LIKE','Rec-%')
                                                      ->whereNotNull('vendor_id')
                                                      ->whereBetween('payment_date',[$fdate,$tdate])->where('status',1)
                                                      ->sum('amount');
                                $totalJournalAmount = \App\Models\JournalEntry::whereBetween('date',[$fdate,$tdate])
                                                      ->whereNotNull('vendor_id')->sum('debit');
                                ...
                                <tr style="font-size: 11px; font-weight:bold; ">
                                    <td colspan="6"><a href="{{url('/deler/index')}}?vendor_id={{$data->id}}" target="_blank"  style="color:red !important;"> {{ $data->d_s_name }}</a>  </td>
                                    <td></td>
                                    <td></td>
                                    <td></td>
                            ...
                            //  $unit = DB::table('sales_products')->where('id',$item->product_id)->value('product_weight_unit');
                                ...
                                <tr>
                                   ...
                                   {{$item->invoice}}
                                    ...
                                    <td class="<?= $clss ?>"> {{$item->narration}}</td>
                                ...
                                <tr style="font-size: 11px; font-weight:bold; color:">
                                    <td class="<?= $clss ?>">{{ date('d-m-y', strtotime($item->ledger_date)) }}</td>
                                ...
                                <tr style="font-size: 12px;color:#fff; font-weight:bold;border-bottom:2px solid;background-color:#c641cf;">
                                ...
                                <tr style="font-size: 13px; font-weight:bold; border-top:2px solid;">
                                  ...
                                  {{--  <td class="text-right">{{ $gt_qtykg }}</td>
                                    ...
                                    @if($type == 'TB')
                                    <td class="text-right">{{ number_format(($gtReturn + $salesReturnOB), 2) }}</td>
                                    <td class="text-right">{{ number_format((($gt_debit) + $salesRevenueOB), 2) }}</td>
                                    @else
