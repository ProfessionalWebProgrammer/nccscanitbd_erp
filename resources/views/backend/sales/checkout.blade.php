...
@section('content')
    ...
    <div class="content-wrapper posclass">
        ...
        <div class="content px-4 ">
            <form action="{{route('sales.checkout.update')}}" method="post">
                @csrf
                <div class="container" style="background:#ffffff; padding:0px 40px;min-height:85vh">
                    ...
                    <div class="row pb-5">
                      ...
                      {{--  id="hidesubmit" --}}
                        <div class="col-md-4 mt-3">
                                  <button type="submit" class="btn custom-btn-sbms-submit btn-primary" id="showsubmit" style="width: 100%"> Checkout Confirm </button>
                                 <button type="button" class="btn custom-btn-sbms-submit "  style="width: 100%;background:red;border: none;display:none" data-toggle="modal" data-target="#modal-default">
