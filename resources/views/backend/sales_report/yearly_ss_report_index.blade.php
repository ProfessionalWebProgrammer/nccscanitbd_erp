        ...
        <div class="content px-4 ">
            <div class="container" style="background:#ffffff; padding:0px 40px;min-height:85vh">
                ...
                <div class="text-center pt-3">
                    <h5 class="text-uppercase font-weight-bold">Yearly Sales Statement Report Input</h5>
                    <hr>
                </div>


                <div class="form">
                    <form class="floating-labels m-t-40" action="{{ Route('yearly.sales.statement.report') }}"
                        method="POST">
                        @csrf
                        <div class="row">
                                ...
                                <div class="form-group m-b-40" id="areaS">
                                    ...
                                    data-live-search="true" data-actions-box="true" multiple name="dlr_area_id[]">
                                        ...
                                        @foreach ($areas as $area)
                                            ...
                                            <option style=" font-weight:bold" value="{{ $area->dlr_area_id }}">
