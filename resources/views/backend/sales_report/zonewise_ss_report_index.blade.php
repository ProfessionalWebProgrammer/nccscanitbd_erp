        ...
        <div class="content px-4 ">
            <div class="container" style="background:#ffffff; padding:0px 40px;min-height:85vh">
                ...
                <div class="text-center pt-3">
                    <h5 class="text-uppercase font-weight-bold">Zone Wise Sales Statement Report Input</h5>
                    <hr>
                </div>


                <div class="form">
                    <form class="floating-labels m-t-40" action="{{ Route('zonewise.sales.statement.report') }}"
                        method="POST">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-4 ">
                                <h5>Select Month: <span id="today" style="color: lime; display:inline-block">This
                                        Month</span></h5>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group m-b-40">
                                    ...
                                    <select class="form-control selectpicker" data-show-subtext="true"
                                        data-live-search="true" data-actions-box="true" multiple name="dlr_zone_id[]">
