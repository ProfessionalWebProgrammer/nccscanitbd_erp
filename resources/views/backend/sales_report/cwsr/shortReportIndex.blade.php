            ...
            <div class="container" style="background:#ffffff; padding:0px 40px;min-height:85vh">
                <div class="row pt-3">
                  	<div class="col-md-12 text-right">
                      	<a href="{{route('category.wise.summary.report.index')}}" class="btn btn-sm btn-success">Sumary Report</a>
                  </div>
                </div>
                

                <div class="text-center pt-3">
                    <h5 class="text-uppercase font-weight-bold">Sales Category Wise Short Sumary Report Input</h5>
                    <hr>
                </div>


                <div class="form">
                    <form class="floating-labels m-t-40" action="{{ Route('category.wise.short.summary.report') }}" method="POST">
                        @csrf
                        <div class="row">
