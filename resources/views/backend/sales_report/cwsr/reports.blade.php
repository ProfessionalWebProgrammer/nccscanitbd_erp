        ...
        <div class="content px-4 ">
          <div class="row pt-3">
                  	<div class="col-md-12 text-right">
                  	    <a href="{{route('category.wise.summary.report.index')}}" class="btn btn-sm btn-danger">Sumary Report</a>
            ...
            <div class="container-fluid" style="background:#ffffff; padding:0px 40px;min-height:85vh" id="contentbody">
                   ...
                   <div class="row pt-2">
                      ...
                      <h5 class="text-uppercase font-weight-bold">Category Wise Sumary Report</h5>
                            ...
                            @foreach ($category as $data)
                                ...
                                @foreach ($product_data as $product)
                                    ...
                                    <tr>
                                        ...
                                        <td align="right">{{ number_format($salesReturnAmount, 2)}}</td>
