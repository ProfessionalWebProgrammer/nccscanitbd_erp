        ...
        <div class="content px-4 ">
            <div class="container-fluid" style="background:#ffffff; padding:0px 40px;min-height:85vh">
              <div class="row pt-3">
                ...
                <div class="text-center pt-3">
                    <h5 class="text-uppercase font-weight-bold">Fiscal Year Comparison Report</h5>
                    ...
                    <table id="" class="table table-bordered table-striped table-fixed"
                        ...
                        <thead>
                            <tr class="table-header-fixt-top">
                              <th>Zone Name</th>
                               <th>January To August 2022 Sales</th>
                               <th>January To August 2021 Sales</th>
