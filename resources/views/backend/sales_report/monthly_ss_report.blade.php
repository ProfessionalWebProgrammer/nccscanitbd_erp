                 ...
                 <div class="challanlogo" align="center" >
                   	...
                   	<div class="row pt-2">
                        <div class="col-md-4 text-left">
                          ...
                          <p>{{ date('F-Y', strtotime($year . '-' . $month)) }}</p>
                        ...
                        <tbody style="font-size: 18px;">
                            ...
                            @foreach ($areadata as $item)
                                ...
                                <tr>
                                    ...
                                    <td>{{ number_format($item->current_sale,2) }}</td>
                                    <td>{{ number_format($item->pre_month_sale,2) }}</td>
                                    <td>{{ number_format($item->pre_pre_month_sale,2) }}</td>
                                    <td></td>
                                    <td>{{ $qutarly }}</td>
                                    <td>{{ number_format($item->current_debit - $item->current_credit,2) }}</td>
                                    <td>{{ number_format($item->pre_month_debit - $item->pre_month_credit,2) }}</td>
                                    <td>{{ number_format($item->dlr_police_station,2) }}</td>
