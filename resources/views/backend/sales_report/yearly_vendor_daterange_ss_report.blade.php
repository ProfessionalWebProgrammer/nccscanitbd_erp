                        ...
                        <tbody>
                            <tr style="font-weight:600; font-size:14px;" class="table-header-fixt-top">
                              ...
                              @endphp
                               ...
                               <tr>
                                        <td colspan="5">{{$dealer->d_s_name}}  (Opening Balance)</td>
                                ...
                                @php
                                         $totalbag =0;
                                  // dd($data);
                          $comission = DB::table('sales_ledgers')->where('vendor_id', $vendor)
                                        ->whereBetween('ledger_date',[$fdate,$tdate])->sum('discount_amount');
                                   @endphp
                                ...
                                ?>
                                   <tr>
                                       ...
                                       <td>{{ ($insentive ?? 0) - ($comission ?? 0)}}</td>
                                        ...
                                        $com = \App\Models\YearlyIncentive::where('category_id', $val->id)->where('min_target_amount','<=', $ton )->where('max_target_amount','>=',$ton)->value('incentive');
                                      	//$insentive = $com*$insentiveQty;	
                                     	@endphp 
                                       <td>@if($com > 0){{$com}}/Kg @else  @endif </td>
