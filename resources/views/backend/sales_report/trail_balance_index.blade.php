        ...
        <div class="content px-4 ">
            <div class="container" style="background:#ffffff; padding:0px 40px;min-height:85vh">
                ...
                <div class="text-center pt-3">
                    <h5 class="text-uppercase font-weight-bold">Trail Banalce Input</h5>
                    <hr>
                </div>


                <div class="form">
                    <form class="floating-labels m-t-40" action="{{ Route('trail.balance.report') }}" method="POST">
                        @csrf
                        <div class="row">

                            <div class="col-md-4">
                                <h5 >Select List type</h5>
                                <div class="form-group m-b-40">
                                    <select class="form-control select2"  name="list_type">
                                        <option value="0">All List</option>
                                        <option value="1">Sales Trail Balance</option>
                                        <option value="2">Purchase Trail Balance</option>
                                        <option value="3">Expanse Trail Balance</option>
                                    </select>
                                </div>
                            </div>
