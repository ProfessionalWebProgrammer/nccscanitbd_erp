        ...
        <div class="container-fluid" style="background:#ffffff; padding:0px 40px;min-height:85vh"  id="contentbody">
            <div class="challanlogo" align="center">
              <div class="row pt-2">
                      ...
                      <h5 class="text-uppercase font-weight-bold">Daily Sales Order Report</h5>
...
<script>
    function loadDataAuto() {
       ...
       // var wirehouseId = $('#warehouse_id').val();
        ...
        $.ajax({
            method: 'GET',
            url: '{{url("daily/sales/order/report/ajaxlist")}}?fdate={{$fdate}}&tdate={{$tdate}}&vid={{$vid}}&aid={{$aid}}&zid={{$zid}}',
               ...
               // console.log(data);
                ...
                for (var i = 0; i < dataList.length; i++) {
                    ...
                    if (dataList[i]['dealer_name'] != null) {
                        ...
                        tqty_kg += parseFloat(dataList[i]['qty']*dataList[i]['product_weight']);
                        ...
                        row += '<td style="color:#000">' + dataList[i]['qty']*dataList[i]['product_weight'] + '</td>';
                ...
                row1 += '<td class="text-right" colspan="6">' + 'Total = ' + '</td>';
