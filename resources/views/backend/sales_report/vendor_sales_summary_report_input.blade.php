        ...
        <div class="content px-4 ">
            <div class="container" style="background:#ffffff; padding:0px 40px;min-height:85vh">
                ...
                <div class="text-center pt-5">
                    <h5 class="text-uppercase font-weight-bold">Vendor Sales Summary Report Input</h5>
                    <hr>
                </div>


                <div class="form">
                    <form class="floating-labels m-t-40" action="{{ Route('vendor.sales.summary.report.input.view') }}" method="POST">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group m-b-40">
                                    ...
                                    data-live-search="true" data-actions-box="true" multiple name="dlr_type[]">
                                         @foreach ($delartype as $type)
                                            <option style=" font-weight:bold" value="{{$type->id}}">
