...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <form class="floating-labels m-t-40" action="{{Route('supplier.group.store')}}" method="POST">
            @csrf
        ...
        <div class="content px-4 ">
            <div class="container" style="background:#ffffff; padding:0px 40px;min-height:85vh">
                <div class="pt-3 text-center">
                    <h4 class="font-weight-bolder text-uppercase text-danger">Supplier Group Create</h4>
                    <hr width="33%">
                </div>
                ...
                <div class="row pt-4">
                    <div class="col-md-8 m-auto">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="group_name" class="form-control" placeholder="Supplier Group Name">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label text-primary">Proprietor Name : </label>
                            <div class="col-sm-9">
                                <input type="text" name="proprietor_name" class="form-control" placeholder="Supplier Proprietor Name">
                            </div>
                        </div>
