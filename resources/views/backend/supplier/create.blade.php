                    ...
                    <div class="col-md-12">
                      <div class="row">
                        ...
                        <div class="form-group col-md-6 row">
                            <label class="col-sm-3 col-form-label text-primary font-weight-bold" >Supplier Name :</label>
                            <div class="col-sm-9">
                                <input type="text" name="supplier_name" class="form-control" placeholder="Supplier Name">
                            </div>
                        </div>
                        <div class="form-group col-md-6 row">
                            <label class="col-sm-3 col-form-label text-primary font-weight-bold" >Organisation :</label>
                            <div class="col-sm-9">
                                <input type="text" name="company" class="form-control" placeholder="Organisation Name">
                            </div>
                        </div>
                        <div class="form-group col-md-6 row">
                        ...
                        <div class="form-group col-md-6 row">
                            <label class="col-sm-3 col-form-label text-primary font-weight-bold" >Desination :</label>
                            <div class="col-sm-9">
                                <input type="text" name="desination" class="form-control" placeholder="Contact Person desination">
                            </div>
                        </div>
                        {{-- <div class="form-group col-md-6 row">
                        ...
                        <div class="form-group col-md-6 row">
                            <label class="col-sm-3 col-form-label text-primary font-weight-bold" >Group Name:</label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group col-md-6 row">
                            <label class="col-sm-3 col-form-label text-primary" > Market Assign : </label>
                            <div class="col-sm-9">
                                <input type="Text" name="market" class="form-control" placeholder="Market Assign">
                            </div>
                        </div>
                        <div class="form-group col-md-6 row">
                            <label class="col-sm-3 col-form-label text-primary" > Agent Assign : </label>
                            <div class="col-sm-9">
                                <input type="Text" name="agent" class="form-control" placeholder="Agent Assign">
                            </div>
                        </div>
                        <div class="form-group col-md-6 row">
