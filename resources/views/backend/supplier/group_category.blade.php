        ...
        <div class="row">
            <div class="col-md-5" style="border-right: 2px solid black">
                ...
                <div class="content px-4 ">
                    ...
                    <form class="floating-labels m-t-40" action="{{ Route('supplier.category.group.store') }}" method="POST">
                        @csrf

                        <div class="container-fluid">
                            <div class="pt-3 text-center">
                                <h4 class="font-weight-bolder text-uppercase">Supplier Category Group</h4>
                                <hr width="33%">
                            </div>
