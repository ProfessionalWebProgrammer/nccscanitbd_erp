            ...
            <div class="container-fluid" style="background:#ffffff; padding:0px 40px;min-height:85vh">
              <div class="row pt-3">
                  	<div class="col-md-12 text-right">
                      	<a href="{{ route('supplier.agent.index') }}" class=" btn btn-success mr-2">Agent Profile</a>
                      	<a href="{{ route('supplier.group.index') }}" class=" btn btn-success mr-2">Supplier Group</a>
                      	<a href="{{ URL('/supplier/create') }}" class=" btn btn-success mr-2">Create Supplier</a>
                    </div>
                </div>
                ...
                <div class="py-4">
                    <div class="text-center">
                        <h5 class="text-uppercase font-weight-bold">Supplier List</h5>
                        <hr>
                    </div>
                            ...
                            @foreach ($supplier as $item)
                                ...
                                <tr>
                                    ...
                                    <td class="text-center align-middle">
                                        <a class="btn btn-xs purchaseedit" style="background-color: #66BB6A" href="{{URL('/supplier/edit/'.$item->id)}}"
