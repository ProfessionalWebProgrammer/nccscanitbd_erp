    ...
    <div class="row">
        <div class="col-md-5" style="border-right: 2px solid black">
            ...
            <div class="content px-4 ">
                ...
                <form class="floating-labels m-t-40" action="{{ Route('dealer.type.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row pt-4">
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" name="type_title" required class="form-control" placeholder="Delar Type Title">
                            </div>


                            <div class="form-group col-md-12">
                                <label class="col-form-label">Type Description :</label>
                                <input type="text" name="type_description" class="form-control" placeholder="Delar Type Description">
                            </div>
                ...
                <div class="container-fluid">
                    <div class="py-4">
                        <div class="text-center">
                            <h5 class="text-uppercase font-weight-bold">Dealer Type List</h5>
                            <hr>
                        </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center align-middle">
                                        <a class="btn btn-xs mb-1 salesedit" style="background-color: #66BB6A" href="{{route('dealer.type.edit',$item->id)}}" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fas fa-edit"></i> </a>
...
<div class="modal fade" id="delete">
    <div class="modal-dialog">
        <div class="modal-content bg-danger">
            ...
            <form action="{{route('dealer.type.delete')}}" method="POST">
                {{ method_field('delete') }}
                @csrf
