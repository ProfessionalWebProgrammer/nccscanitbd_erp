    ...
    <div class="content-wrapper salescontent">
        ...
        <div class="content px-4 ">
             <div class="container-fluid" style="background: #ffffff; padding: 0px 40px;">
               <div class="row pt-3">
                	<div class="col-md-4">
                      	 <a href="{{ route('dealer.tc.archive.log') }}" class=" btn btn-sm btn-success mr-2">Archive Transport Cost Log</a>
                    </div>
                ...
                <div class="py-4">
                    <div class="text-center">
                        <h5 class="text-uppercase font-weight-bold">Vendor Archive List</h5>
                        <hr>
                    </div>
                    <div class="my-3">
                    ...
                    <table id="example1" class="table table-bordered table-striped" style="font-size: 15px;">
                        ...
                        @php
                        $updated_user = DB::table('users',$dlr->updated_user)->value('name');
                        @endphp
                            <tr>
