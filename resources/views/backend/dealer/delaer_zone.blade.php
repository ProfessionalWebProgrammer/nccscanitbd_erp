       ...
       <div class="row">
            <div class="col-md-5" style="border-right: 2px solid black">
                ...
                <div class="content px-4 ">
                    ...
                    <form class="floating-labels m-t-40" action="{{ Route('dealer.zone.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row pt-4">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" name="zone_title" required class="form-control"
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" name="zone_description" class="form-control"
                    ...
                    <div class="container-fluid">
                        <div class="py-4">
                            <div class="text-center">
                                <h5 class="text-uppercase font-weight-bold">Dealer Zone List</h5>
                                <hr>
                            </div>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($dealerzone as $item)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $item->main_zone }} </td>
                                            <td>{{ $item->zone_description }} </td>
                                            <td class="text-center align-middle">
                                                <a class="btn btn-xs mb-1 salesedit" style="background-color: #66BB6A" href="{{route('dealer.zone.edit',$item->id)}}"
