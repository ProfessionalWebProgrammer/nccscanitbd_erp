...
<div class="">
    <li class="nav-item d-none d-sm-inline-block mt-2">
        <a href="{{ route('manufacturing.newCost.create') }}" class=" btn btn-xs btn-success mr-2">Create Mnufacturing Cost</a>
   </li>
</div>
@endsection
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                  {{--  <a href="{{route('manufacturing.newCost.edit',$item->invoice)}}" class="btn btn-sm btn-info"><span class="fa fa-edit"></span></a> --}}
    ...
    <div class="modal fade" id="delete">
            <div class="modal-dialog">
                <div class="modal-content bg-danger">
                    ...
                    <form action="{{route('manufacturing.newCost.delete')}}" method="POST">
                        {{ method_field('delete') }}
                        @csrf
