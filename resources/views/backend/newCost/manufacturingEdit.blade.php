    ...
    <div class="content-wrapper">
      <div class="content px-4 ">
        <div class="container">
            ...
            <form class="floating-labels m-t-40" action="{{route('manufacturing.newCost.update')}}" method="POST">
                @csrf
                <div class="row">
                    <div class="col-md-12">
                                                            ...
                                                            <div class="col-md-2">
                                                                <div class="form-group">
                                                                    <input type="number" name="rate[]"
                                                                      class="form-control rate" step="any" value="{{$val->rate}}">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <input type="number" name="total_cost[]"
                                                                        class="form-control total_cost" step="any" value="{{$val->total_cost}}" readonly>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
