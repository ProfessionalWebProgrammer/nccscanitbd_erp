    ...
    <div class="content-wrapper">
        <div class="content">
            <div class="container">
                ...
                <form class="floating-labels m-t-40" action="{{ route('direct.labour.newCost.store') }}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row">
							...
							<div class="form-group col-md-2">
                                    ...
                                    <input type="text"  name="chalan_no" class="form-control" >
                              		<span class="text-danger" style="font-size:11px">Cost Chalan No must be Unique</span>
                                </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label class=" col-form-label"> Head (Ledger):</label>
                                                            </div>
                                                        </div>
