...
@section('content')
    ...
    <div class="content-wrapper posclass">
        ...
        <div class="content px-4 ">
          <form action="{{route('sales.order.confirm.update')}}" method="post">
                @csrf
                <div class="container" style="background:#ffffff; padding:0px 40px;min-height:85vh">
                    <div class="row pt-4">
                        ...
                        <div class="col-md-2 text-right">
                           ...
                           <div class="mb-3">
							 ...
							 <input type="hidden" class="form-control " name="item_type" value="{{$orderdetails->item_type}}">
                                                ...
                                                <div class="row">
                                                   ...
                                                   <div class="col-md-1"> <label for="">Stock :</label>
                                                    ...
                                                    <div class="col-md-1">
                                                        ...
                                                        <input type="text" class="form-control discount"  name="discount[]" placeholder="%" value="{{$item->discount}}">
                    ...
                    <div class="row pb-5">
                        ...
                        <div class="col-md-4 mt-3">
                            ...
                            <button type="submit" class="btn custom-btn-sbms-submit" name="update" value="1" style="width: 100%">Update Order </button>
                       </div>
                       {{-- @if (Auth::id() == 101) --}}
                            <div class="col-md-4 mt-3">
                  ...
                  alert("Please Select Vendor Aan Warehouse First");
                    ...
                    $.ajax({
                            ...
                            success : function(data){
                              //  console.log(data);
                              if(data.stock > 0) {
                                parent.find('.pstock').val(data.stock);
