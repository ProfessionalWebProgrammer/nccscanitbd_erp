    ...
    <div class="content-wrapper posclass">
				<div class="row pt-2 pb-2">
                      ...
                      <div class="col-md-3 text-left">
                      	<a href="{{route('sales.order.index')}}" class="btn btn-sm btn-success">Order List</a>
                    </div>
                </div>
            ...
            <form action="{{route('sales.order.store')}}" method="post">
                ...
                <div class="container" style="background: #ffffff; padding: 0px 40px; min-height:85vh">
                  <div class="text-center py-2">
                    ...
                    <div class="row pt-4">
                        <div class="col-md-3">
                          ...
                          <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control select2" required name="type_id" id="product_type" required >
                        ...
                        <div class="col-md-2 text-right">
                            <div class="mb-3">
                                Invoice No:<span class="mt-4 font-weight-bold"> Sal-</span><span class="mt-4 font-weight-bold" id="invoiceNo"> </span>
                                    ...
                                    <div class="row">
                                        <div class="col-md-11">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4 fgProduct" style="display: none">
                                              	...
                                              	<div class="col-md-4 RawProduct" style="display: none">
                                                    <label for="">Product Name:</label>
                                                    <select class="form-control select2 products_id"
                                                        name="raw_products_id[]"
                    ...
                    <div class="row">
                        <div class="col-md-6">
                          <label for="naration" class="mt-5">Narration</label>
                          <input type="text" class="form-control" name="naration" value="">
                        </div>
...
<script>
    $(document).ready(function() {
        ...
        $("body").on("click", ".addMore", function() {
            x = x+1;
            var fieldHTML =
                '<div class="row fieldGroup rowname mt-2"> <div class="col-md-12"> <div class="row"> <div class="col-md-11"> <div class="row"> <div class="col-md-4 fgProduct" style="display: none"> <select class="form-control select2 products_id" name="products_id[]" data-live-search-style="startsWith" id="products_id" required> <option value=" " selected>Select Product</option> @foreach ($products as $product) <option style="color:#000;font-weight:600;" value="{{ $product->id }}">{{ $product->product_name }} </option> @endforeach </select> </div> <div class="col-md-4 RawProduct" style="display: none"> <select class="form-control select2 products_id" name="raw_products_id[]" data-live-search-style="startsWith" required> <option value=" " selected>Select Product</option> @foreach ($rawProducts as $product) <option style="color:#000;font-weight:600;" value="{{ $product->id }}">{{ $product->product_name }} </option> @endforeach </select> </div> <div class="col-md-2"> <input type="text" class="form-control stock" name="stock[]" readonly> </div> <div class="col-md-2"> <input type="text" class="form-control p_price" name="p_price[]" placeholder="Price"> </div> <div class="col-md-2"> <input type="text" class="form-control p_qty" name="p_qty[]" placeholder="Quantity"> </div> <div class="col-md-2"> <input type="hidden" readonly class="form-control total_price" name="total_price[]" placeholder="total"> <input type="text" readonly class="form-control total_price_without_discount" name="total_price_without_discount[]"> </div> </div> </div> <div class="col-md-1"> <a href="javascript:void(0)" style="margin-top: 3px;" class="btn custom-btn-sbms-add btn-sm addMore"><i class="fas fa-plus-circle"></i></a> <a href="javascript:void(0)" class="btn btn-sm custom-btn-sbms-remove remove" style="margin-top: 3px;"><i class="fas fa-minus-circle"></i></a> </div> </div> </div> </div>';
      ...
      function selected() {
                ...
                var x = $('#product_type').val();

                if (x == "fg") {


                    var elems = document.getElementsByClassName('fgProduct');
                    var elems2 = document.getElementsByClassName('RawProduct');
