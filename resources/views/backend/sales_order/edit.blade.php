                ...
                <div class="container" style="background:#ffffff; padding:0px 40px;min-height:85vh">
                    <div class="row pt-4">
                        <div class="col-md-3">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="date" value="{{$orderdetails->date}}" class="form-control" name="testdate">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-7">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    >
                                        ...
                                        @foreach ($dealers as $dealer)
                                            <option style="color:#000;font-weight:600;" value="{{ $dealer->id }}" @if($orderdetails->dealer_id ==$dealer->id) selected @endif>
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control select2"
                                        ...
                                        @foreach ($factoryes as $factorye)
                                            <option style="color:#000;font-weight:600;" value="{{ $factorye->id }}" @if($orderdetails->warehouse_id ==$factorye->id) selected @endif>
                        ...
                        <div class="col-md-2 text-right">
                            <div class="mb-3">
                                Invoice No: <span class="mt-4 font-weight-bold" id="invoiceNo"> {{$orderdetails->invoice_no}} </span>
                                <input type="hidden" name="invoice" value="{{$orderdetails->invoice_no}}">
                               <input type="hidden" name="item_type" value="{{$orderdetails->item_type}}">
                            </div>
                           <div class="mb-3">
                             ...
                             <input type="hidden" class="form-control " id="invoicegt" value="{{$orderdetails->grand_total}}" >


                            </div>
                           {{--<div class="mb-3">
                                Sales Value: <span class="mt-4 font-weight-bold" > {{$orderdetails->grand_total}}</span>
                    ...
                    <div class="row mt-5">
                        <div id="field" class="col-md-12">
                            ...
                            @php
                            $discount = \App\Models\SalesItem::where('invoice_no', $item->invoice_no)->where('product_id',$item->product_id)->value('discount');
                            @endphp
                                                ...
                                                <div class="row">
                                                   ...
                                                   <div class="col-md-1"> <label for="">Stock :</label>
                                                    ...
                                                    <div class="col-md-2">
                                                        ...
                                                        <input type="text" class="form-control p_price" required name="p_price[]" placeholder="Price" value="{{$item->unit_price}}">
                                                    </div>
                                                    <div class="col-md-2">
                                                        <label for="">Quantity :</label>
                                                        <input type="text" class="form-control p_qty" name="p_qty[]" placeholder="Quantity" value="{{$item->qty}}">
                                                    </div>
                                                    <div class="col-md-1">
                                                        <label for="">Discount:</label>
                                                        <input type="text" class="form-control discount"  name="discount[]" placeholder="%" value="{{$discount}}">
                                                        <input type="hidden" class="form-control discount_amount"  name="discount_amount[]" value="{{$item->discount_amount}}">
                                                    </div>
                                                    <div class="col-md-1">
                                                        <label for="">Bonus :</label>
                                                        <input type="text" class="form-control bonus"  name="bonus[]" placeholder="" value="{{$item->bonus}}">
                                                    </div>
                                                    <div class="col-md-2">
                                                        ...
                                                        <input type="text" readonly tabIndex="-1" class="form-control total_price_without_discount"  name="total_price_without_discount[]" value="{{$item->qty*$item->unit_price}}">
                    ...
                    <div class="row">
                        <div class="col-md-6 mt-3">
                          ...
                          <div class="mt-5">
                            	...
                            	<textarea name="narration" class="form-control bonus" cols="30" rows="2">{{$orderdetails->narration}}</textarea>
                          </div>
                        </div>
                            ...
                            <table class="table  border table-sm">
                                ...
                                <tfoot>
                                   ...
                                   <tr class=" font-weight-bold">
                                        ...
                                        <input type="hidden" class="form-control " id="edited_value"  >
                    ...
                    <div class="row pb-5">
                        ...
                        <div class="col-md-4 mt-3">
                            ...
                            <button type="submit" class="btn custom-btn-sbms-submit" name="update" value="1" style="width: 100%">Update & Confirm Order </button>
                       </div>
                       {{-- @if (Auth::id() == 101)
                            <div class="col-md-4 mt-3">
                                 <button type="submit" class="btn custom-btn-sbms-submit btn-primary" value="1" name="confirm" id="showsubmit" style="width: 100%"> Checkout Confirm </button>
...
<script>
    ...
    $(document).ready(function() {
      ...
      $('#modal-default').on('show.bs.modal', function(event) {
        ...
        $('#field').on('change','.total_price',function(){
      ...
      function dealercreati(){
       ...
       var vendor_id =  $('#dealer').val();
        ...
        function creditlimitcalculation(){
         ...
         // var toatalexta = Number(totalval)- Number(fcl)
