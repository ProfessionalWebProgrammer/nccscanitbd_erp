        ...
        <div class="row">
            <div class="col-md-6" style="border-right: 2px solid black">
                ...
                <div class="content px-4 ">
                    ...
                    <form class="floating-labels m-t-40" action="{{ Route('sales.category.store') }}" method="POST">
                        @csrf

                        <div class="container-fluid">
                            <div class="pt-3 text-center">
                                <h4 class="font-weight-bolder text-uppercase">Sales Category Create</h4>
                                <hr width="33%">
                            </div>
                    ...
                    <div class="container-fluid">
                        <div class="py-4">
                            <div class="text-center">
                                <h5 class="text-uppercase font-weight-bold">Category List</h5>
                                <hr>
                            </div>
                                    ...
                                    @foreach ($categorys as $item)
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center align-middle">
                                                <a class="btn btn-xs text-light salesedit" style="background-color: #66BB6A" href="{{URL::to('/sales/category/edit/'.$item->id)}}"
