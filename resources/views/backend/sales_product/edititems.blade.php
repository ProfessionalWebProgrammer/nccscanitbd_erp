                    ...
                    <div class="row pt-4">
                        <div class="col-md-6">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <select class="form-control select2" style="padding: 0px 10px 10px 10;"
                                        ...
                                        @foreach ($units as $val)
                                            <option value="{{ $val->id }}" @if ($itemdata->product_weight_unit == $val->id) selected @endif >{{ $val->unit_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div id="field" class="col-md-12">
                                <div class="row fieldGroup rowname">
                                   @foreach($warehousProducts as $warehouse)
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-md-10">
                                                <div class="row">
                                                      ...
                                                      <select class="form-control select2 products_id" name="warehouse_id[]"
                                                          ...
                                                          @foreach ($warehous as $val)
                                                              <option style="color:#000;font-weight:600;"
                                                                  value="{{ $val->id }}" @if($warehouse->warehouse_id == $val->id) selected  @else   @endif >{{ $val->factory_name }}
                                                              </option>
                                                          @endforeach
                                                      </select>
                                                  ...
                                                  <div class="col-md-4">
                                                      ...
                                                      <input type="text" class="form-control p_qty" name="opening[]" value="{{ $warehouse->opening }}">
                                                  </div>
                                                </div>
                                             </div>
                                             <div class="col-md-2">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control select2" style="padding: 0px 10px 10px 10;"
                                        ...
                                        @foreach ($units as $val)
                                            <option value="{{ $val->id }}" @if ($itemdata->product_unit == $val->id) selected @endif>{{ $val->unit_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" value="{{$itemdata->rate}}" name="rate">
                                <span class="text-danger"></span>
                                </div>
                            </div>
                            <div class="form-group row">
