        ...
        <div class="row">
            <div class="col-md-6" style="border-right: 2px solid black">
                ...
                <div class="content px-4 ">
                    ...
                    <form class="floating-labels " action="{{ Route('sales.sub.category.store') }}" method="POST">
                        @csrf

                        <div class="container-fluid">
                            <div class="pt-2 text-center">
                                <h4 class="font-weight-bolder text-uppercase">Sales Sub Category Create</h4>
                                <hr width="33%">
                            </div>
                    ...
                    <div class="container-fluid">
                        <div class="py-4">
                            <div class="text-center">
                                <h5 class="text-uppercase font-weight-bold">Sub Category List</h5>
                                <hr>
                            </div>
                                    ...
                                    @foreach ($categorys as $item)
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center align-middle">
                                                <a class="btn btn-xs text-light salesedit" style="background-color: #66BB6A" href="{{URL::to('/sales/subCategory/edit/'.$item->id)}}"
    ...
    <div class="modal fade" id="delete">
            <div class="modal-dialog">
                <div class="modal-content bg-danger">
                    ...
                    <form action="{{route('sales.sub.category.delete')}}" method="POST">
                        {{ method_field('delete') }}
                        @csrf
