            ...
            <div class="container-fluid" style="background: #ffffff; padding: 0px 40px;">
              	<div class="row pt-3">
                  	<div class="col-md-12 text-right">
                      	...
                      	<a href="{{route('sales.item.create')}}" class="btn btn-sm btn-success">Create Product </a>
                      	<a href="{{route('sales.category.index')}}" class="btn btn-sm btn-success">Product Category</a>
                        <a href="{{route('sales.sub.category.index')}}" class="btn btn-sm btn-success">Product Sub Category</a>
                    </div>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                       <a class="btn btn-xs salesedit" style="background-color: #66BB6A"
                                            href="{{ URL::to('/sales/item/edit/' . $data->id) }}" data-toggle="tooltip"
    ...
    <div class="modal fade" id="delete">
            <div class="modal-dialog">
                <div class="modal-content bg-danger">
                    ...
                    <form action="{{route('sales.item.delete')}}" method="POST">
                        {{ method_field('delete') }}
                        @csrf
