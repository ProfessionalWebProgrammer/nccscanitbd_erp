                    ...
                    <div class="col-md-12">
                        <form class="floating-labels m-t-40" action="{{ route('general.purchase.transfer.store') }}"
                            ...
                            <div class="pt-4 text-center">
                                <h4 class="font-weight-bolder text-uppercase">Create General Transfer</h4>
                                <hr width="33%">
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2" name="factory_out_id" id="" required>
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2" name="factory_in_id" id="" required>
                                                    <option value="">Select Wirehouse</option>
                                                    @foreach ($wirehouse as $wh)
                                                        <option style="color:#000;font-weight:600;"
                                                            value="{{ $wh->wirehouse_id }}">
                            ...
                            <div class="row pb-5">
                                <div class="col-md-12 mt-3 text-center">
                                    <button type="submit" class="btn custom-btn-sbms-submit" style=""> Transfer Confirm
                                    </button>
                                </div>
                            </div>
                        </form>
