                        ...
                        <tbody style="font-size: 18px;">
                            ...
                            @foreach ($data as $pdata)
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">{{Auth::User()->where('id',$invouicedata->created_by)->value('name')}}</br> <small>{{ date('d M,Y h:i A', strtotime($invouicedata->created_at)) }}</small></td>
                                    ...
                                    <td class="text-center align-middle">
                                        <a class="btn btn-sm purchaseedit mt-2"
                                        ...
                                        <a class="btn btn-sm btn-primary  mt-2" href="{{ URL('/general/purchase/view/' . $pdata->invoice_no) }}" data-toggle="tooltip"
                                            data-placement="top" title="View Invoice"><i class="far fa-eye"></i> </a>
                                        <a class="btn btn-sm btn-danger purchasedelete mt-2" href="" data-toggle="modal" data-target="#delete"
