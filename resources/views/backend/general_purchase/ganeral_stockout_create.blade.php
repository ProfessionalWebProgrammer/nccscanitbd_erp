                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" name="wirehouses_id" id="" required>
                                                <option value="">Select Wirehouse</option>
                                                @foreach ($wirehouses as $wh)
                                                    <option style="color:#000;font-weight:600;"
                                                        value="{{ $wh->wirehouse_id }}" @if ($wh->wirehouse_id == $wr_id) selected @endif>
                                                        {{ $wh->wirehouse_name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-3">
                                                                ...
                                                                <input type="number" step="any" class="form-control"
                                                                    name="p_qty[]" placeholder="Quantity">
                                                            </div>
                                                            <div class="col-md-3">
