            ...
            <div class="container-fluid">
                <div class="row" style="min-height: 85vh">
                    <div class="col-md-4" style="border-right: solid #003B46">
                        <form class="floating-labels m-t-40" action="{{ route('general.purchase.generalcategory.store') }}"
                            method="POST">
                            @csrf

                            <div class="pt-4 text-center">
                                <h4 class="font-weight-bolder text-uppercase">Create General Category</h4>
                                <hr width="33%">
                            </div>

                            <div class="row pt-3">
                                <div class="form-group col-md-12">
                                    <label class=" col-form-label">Others Category Name :</label>
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="py-4">
                            <div class="text-center">
                                <h3 class="text-uppercase font-weight-bold">General Category List</h3>
                                <hr>
                            </div>
                                    ...
                                    @foreach ($categories as $item)
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center align-middle">
                                                ...
                                                <a class="btn btn-sm btn-danger purchasedelete" href="" data-toggle="modal"
    ...
    <div class="modal fade" id="delete">
        <div class="modal-dialog">
            <div class="modal-content bg-danger">
                ...
                <form action="{{ route('general.category.delete') }}" method="POST">
                    {{ method_field('delete') }}
                    @csrf
