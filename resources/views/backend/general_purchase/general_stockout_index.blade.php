                    ...
                    <table id="example1" class="table table-bordered table-striped table-fixed" style="font-size: 15px;">
                        ...
                        <tbody style="font-size: 18px;">
                            ...
                            @foreach ($stockoutdata as $tdata)
                          		@php
                          			$qntty_total += $tdata->quantity;
                          			$totalprice +=  $tdata->quantity*$tdata->price;
                          		@endphp
                                <tr>
                                    <td class="text-center">{{ $loop->iteration }}</td>
                                    <td class="text-center">{{ $tdata->id }}</td>                                  
                                    <td class="text-center">{{ date('d-F-Y', strtotime($tdata->date)) }}</td>
                                    <td class="text-center">{{ $tdata->wirehouse_name }}</td>
                                    ...
                                    <td class="text-center align-middle">
                                        <a class="btn btn-sm purchaseedit"
                                            ...
                                            href="{{ URL('/general/purchase/stockout/edit/' . $tdata->id) }}"
                      	...
                      	<tfoot>
                           <tr class="text-center table-header-fixt-top">
                                ...
                                <th></th>
                                <th></th>
                                <th class="text-right">{{$qntty_total}}</th>
                                <th></th>
