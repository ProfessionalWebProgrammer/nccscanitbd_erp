       ...
       <div class="row">
        ...
        <div class="row pt-3">
            <div class="col-md-4 m-auto sales_main_button">
                <a href="{{route('employee.pay.roll.list')}}" class="text-center pt-1 pb-2 py-3 btn btn-block  text-center linkbtn" >Employee Payroll</a>
            </div>
        </div>
          ...
          <div class="row pt-5 px-3 text-center">
            ...
            <div class="col-md-2 p-1 sales_button" style="border-radius: 8px;">
                <div class="mx-1">
                  <a href="{{route('employee.salary.pay.list')}}" class="btn btn-block  text-center py-3 linkbtn">Salary Processing</a>
                </div>
            </div>
            <div class="col-md-2 p-1 sales_button" style="border-radius: 8px;">
                <div class="mx-1">
                  <a href="{{ route('hrpayroll.employee.loan.list') }}" class="btn btn-block  text-center py-3 linkbtn">Loan and Advance</a>
                </div>
            </div>
            <div class="col-md-2 p-1 sales_button" style="border-radius: 8px;">
                <div class="mx-1">
                  <a href="#" class="btn btn-block  text-center py-3 linkbtn">Payment Processing</a>
                </div>
            </div>
            <div class="col-md-2 p-1 sales_button" style="border-radius: 8px;">
                <div class="mx-1">
                  <a href="{{route('hrpayroll.employee.bonusPayment.list')}}" class="btn btn-block  text-center py-3 linkbtn">Bonus Payment</a>
                </div>
            </div>
            <div class="col-md-2 p-1 sales_button" style="border-radius: 8px;">
                <div class="mx-1">
                  <a href="{{route('hrpayroll.employee.reimbursementPayment.list')}}" class="btn btn-block  text-center py-3 linkbtn">Reimbursement</a>
                </div>
            </div>
            <div class="col-md-2 p-1 sales_button" style="border-radius: 8px;">
                <div class="mx-1">
                  <a href="{{route('hrpayroll.employee.arrearPayment.list')}}" class="btn btn-block  text-center py-3 linkbtn">Arrear Payment</a>
                </div>
            </div>
            <div class="col-md-2 p-1 sales_button" style="border-radius: 8px;">
                <div class="mx-1">
                  <a href="{{route('hrpayroll.employee.miscellaneousPayment.list')}}" class="btn btn-block  text-center py-3 linkbtn">Miscellaneous Payment</a>
                </div>
            </div>
            <div class="col-md-2 p-1 sales_button" style="border-radius: 8px;">
                <div class="mx-1">
                  <a href="{{route('hrpayroll.employee.subsidiary.list')}}" class="btn btn-block  text-center py-3 linkbtn">Subsidiary</a>
                </div>
            </div>
