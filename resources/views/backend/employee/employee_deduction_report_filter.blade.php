...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content px-4 pt-5">
          	<h4 class="text-center">Employee Monthly Deductions Report</h4> <hr>
            <div class="form container pt-3">
                    <form class="floating-labels m-t-40" action="{{route('employee.monthly.deduction.view')}}" method="POST">
                        @csrf
                        <div class="row">
