        ...
        <div class="row">
            <div class="col-md-6" style="border-right: 2px solid black">
                ...
                <div class="content px-4 ">
                    ...
                    <form class="floating-labels m-t-40" action="{{ Route('employee.designation.store') }}" method="POST">
                        @csrf

                        <div class="container-fluid">
                            <div class="pt-3 text-center">
                                <h4 class="font-weight-bolder text-uppercase">Employee Designation Create</h4>
                                <hr width="33%">
                            </div>
                            ...
                            <div class="row pt-4">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" name="designation_title" class="form-control"
                    ...
                    <div class="container-fluid">
                        <div class="py-4">
                            <div class="text-center">
                                <h5 class="text-uppercase font-weight-bold">Employee Designation List</h5>
                                <hr>
                            </div>
