            ...
            <div class="container-fluid">
                <div class=" row pt-3">
                  <div class="col-md-12 text-right">
                      	<a href="{{route('employee.brach.transfer.create')}}" class="btn btn-sm btn-success">Branch Transfer Create</a>
                      	<a href="{{route('employee.department.transfer.list')}}" class="btn btn-sm btn-success">Department Transfer</a>
                ...
                <div class="py-4 table-responsive">
                    <div class="text-center">
                        <h5 class="text-uppercase font-weight-bold">Branch Transfer List</h5>
                        <hr>
                    </div>
