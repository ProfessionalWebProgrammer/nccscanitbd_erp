            ...
            <form action="#" method="POST">
                @csrf
                    ...
                    <div class="pt-3 text-center">
                        <h4 class="font-weight-bolder text-uppercase">Branch Transfer </h4>
                        <hr width="33%">
                    </div>
                    <div class="row pt-4">
                      <div class="col-md-6">
                     ...
                     <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label"> From Branch :</label>
                                <div class="col-sm-9">
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label"> To Branch :</label>
                                <div class="col-sm-9">
