            ...
            <div class="row" style="min-height: 85vh">
                <div class="col-md-12">
                    ...
                    <div class="content px-4 ">
                        ...
                        <form class="floating-labels m-t-40" action="{{ route('general.purchase.stockout.store') }}"
                            method="POST">
                            @csrf
                            <div class="container-fluid">
                                <div class="pt-4 text-center">
                                    <h4 class="font-weight-bolder text-uppercase text-danger">Create General Stockout</h4>
                                    <hr width="33%">
                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-11">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-2">
                                                                <label for="" class="text-primary">Dimension :</label>
                                                                <input type="text" class="form-control dimension"
                                                                    name="dimension[]" placeholder="Dimension">
                                                            </div>
                                                            <div class="col-md-2">
                                ...
                                {{-- multiple add end on here --}}
                              	<div class="row">
                                    <div class="col-md-6 m-auto">
                                        <div class="form-group">
                                            <label for="" class="text-primary">Note:</label>
                                ...
                                <div class="row pb-5">
                                    <div class="col-md-12 mt-3 text-center">
                                        <button type="submit" class="btn custom-btn-sbms-submit btn-primary" style=""> Stockout Confirm
                                        </button>
                                    </div>
                                </div>
                            </div>
