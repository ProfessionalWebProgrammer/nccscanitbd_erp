        ...
        <div class="content px-4 ">
            <div class="container" style="background:#ffffff; padding:0px 40px;min-height:85vh">
                ...
                <div class="text-center pt-3">
                    <h5 class="text-uppercase font-weight-bold">General Purchase Stock Report Input</h5>
                    <hr>
                </div>


                <div class="form">
                    <form class="floating-labels m-t-40" action="{{ Route('general.purchase.stock.report.view') }}" method="POST">
                        @csrf
                        <div class="row" style="margin-top:25vh;">
                            ...
                            <div class="col-md-4">
                                <h5 class="text-primary">Select Product</h5>
                                <div class="form-group m-b-40">
                                    ...
                                    <select class="form-control selectpicker border border-secondary" data-show-subtext="true"
                                        data-live-search="true"  data-actions-box="true" multiple name="warehouse_id[]">
                                         @foreach ($wirehouse as $w)
                                            <option style="color: #FF0000" value="{{ $w->wirehouse_id  }}"
                                                >{{ $w->wirehouse_name }}
                                            </option>
                                        @endforeach
                                    </select>
