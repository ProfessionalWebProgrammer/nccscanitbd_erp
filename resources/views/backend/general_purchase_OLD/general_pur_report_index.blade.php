        ...
        <div class="content px-4 ">
            <div class="container" style="background:#ffffff; padding:0px 40px;min-height:85vh">
                ...
                <div class="text-center pt-3">
                    <h5 class="text-uppercase font-weight-bold text-danger">General Purchase Report</h5>
                    <hr style="background: #ffffff78;">
                </div>


                <div class="form container">
                    <form class="floating-labels m-t-40" action="{{ Route('general.purchase.report.view') }}"
                        method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <label class="text-primary">Select Daterange: </label>
                            ...
                            <div class="col-md-6">
                                ...
                                <label class="text-primary">Select Supplier</label>
                                <div class="form-group m-b-40">
                                    ...
                                    <select class="form-control selectpicker" data-show-subtext="true"
                                        ...
                                        @foreach ($suppliers as $sp)
                                            <option style=" font-weight:bold" value="{{ $sp->id }}">
                                                {{ $sp->supplier_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <label class="text-primary">Select Wirehouse</label>
                                <div class="form-group m-b-40">

                                    <select class="form-control selectpicker" data-show-subtext="true"
                                        data-live-search="true" data-actions-box="true" multiple name="factories[]">
                                        {{-- <option value="">Select Product</option> --}}
