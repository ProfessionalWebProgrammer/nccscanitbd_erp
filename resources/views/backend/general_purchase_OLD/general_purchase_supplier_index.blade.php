        ...
        <div class="content px-4 ">
            <div class="container-fluid" style="background:#ffffff; padding:0px 40px;min-height:85vh">
              <div class="row mt-3">
                      ...
                      <a href="{{ route('general.purchase.supplier.create') }}" class=" btn btn-sm btn-success mr-2">Create General Supplier</a>
                    </div>
                </div>
                ...
                <div class="py-4">
                    <div class="text-center">
                        <h5 class="text-uppercase font-weight-bold">General Supplier List</h5>
                        <hr>
                    </div>
                     	...
                     	<tbody>
                            ...
                            @foreach ($suppliers as $item)
                                ...
                                @php
                                    ...
                                    $groupname = DB::table('supplier_groups')->where('id',$item->group_id)->value('group_name');
                                @endphp
                                <tr>
                                    ...
                                    <td class="text-center align-middle">
                                        <a class="btn btn-sm purchaseedit" style="background-color: #66BB6A" href="{{URL::to('/general/purchase/supplier/edit/'.$item->id)}}"
    ...
    <div class="modal fade" id="delete">
            <div class="modal-dialog">
                <div class="modal-content bg-danger">
                    ...
                    <form action="{{ route('general.purchase.supplier.delete') }}" method="POST">
                        {{ method_field('delete') }}
                        @csrf
