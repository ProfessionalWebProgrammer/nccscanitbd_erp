            ...
            <div class="row" style="min-height: 85vh">
                <div class="col-md-12">
                    ...
                    <div class="content px-4 ">
                        ...
                        <form class="floating-labels m-t-40" action="{{ route('general.purchase.transfer.store') }}"
                            method="POST">
                            @csrf
                            <div class="container-fluid">
                                <div class="pt-4 text-center">
                                    <h4 class="font-weight-bolder text-uppercase">Create General Product Transfer</h4>
                                    <hr width="33%">
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <label for="">Transfer Out Wirehouse Name:</label>
                                                    <select class="form-control select2" name="factory_out_id" id=""
                                                        required>
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <label for="">Transfer In Wirehouse Name:</label>
                                                    <select class="form-control select2" name="factory_in_id" id=""
                                                        required>
                                                        <option value="">Select Wirehouse</option>
                                                        @foreach ($wirehouse as $wh)
                                                            <option style="color:#000;font-weight:600;"
                                ...
                                <div class="row pb-5">
                                    <div class="col-md-12 mt-3 text-center">
                                        <button type="submit" class="btn btn-primary custom-btn-sbms-submit" style=""> Transfer Confirm
                                        </button>
                                    </div>
                                </div>
                            </div>
