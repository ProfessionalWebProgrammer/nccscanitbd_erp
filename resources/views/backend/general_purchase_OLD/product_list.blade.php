                            ...
                            <div class="py-4">
                                <div class="">                                    
                                    ...
                                    <div class="col-md-6 text-right">
                                        <a href="{{ route('general.product.create') }}" class="btn btn-sm btn-primary">
                                            Create Product</a>
                                    </div>
                                </div>
                                <hr>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($productdata as $item)
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">{{ $item->dimensions }}
                                            </td>
                                            <td class="text-center align-middle">
                                                <a class="btn btn-sm text-light purchaseedit" style="background-color: #66BB6A" href="{{URL::to('/general/purchase/general/product/edit/'.$item->id)}}"
