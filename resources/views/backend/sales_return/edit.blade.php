...
@section('content')
    ...
    <div class="content-wrapper posclass">
        ...
        <div class="content px-4 ">
            <form action="{{route('sales.return.update')}}" method="post">
                @csrf
               <div class="container-fluid" style="background:#ffffff; padding:0px 40px;min-height:85vh">
                    <h3 class="text-center">Sales Return Create</h3>
                    <div class="row pt-4">
                        <div class="col-md-3">
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-3 col-form-label">Date : </label>
                                <div class="col-sm-9">
                                    <input type="date" value="{{$returnsdetails->date}}" class="form-control" name="testdate">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-7">
                    ...
                    <div class="row pb-5">
                        ...
                        <div class="col-md-4 mt-3">
                                 <button type="submit" class="btn custom-btn-sbms-submit" style="width: 100%"> Return Confirm </button>
                         </div>
                        <div class="col-md-4 mt-3">
