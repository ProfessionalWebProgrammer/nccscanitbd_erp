...
@section('content')
    ...
    <div class="content-wrapper posclass">
        ...
        <div class="content px-4 ">
            <form action="{{route('fg.sales.return.update')}}" method="post">
                @csrf

               <div class="container-fluid" style="background:#ffffff; padding:0px 40px;min-height:85vh">
                    <h3 class="text-center">Sales Return Edit</h3>
                    <div class="row pt-4">
                        <div class="col-md-3">
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-3 col-form-label">Date : </label>
                                <div class="col-sm-9">
                                    <input type="date"  class="form-control" name="date" value="{{$returnsdetails->date}}">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-7">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control select2" name="dealer_id" id="dealer" >
                                        ...
                                        @foreach ($dealers as $dealer)
                                            <option style="color:#000;font-weight:600;" value="{{ $dealer->id }}" @if($returnsdetails->dealer_id == $dealer->id ) selected @endif>
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control select2"
                                        ...
                                        @foreach ($factoryes as $factorye)
                                            <option style="color:#000;font-weight:600;" value="{{ $factorye->id }}" @if($returnsdetails->warehouse_id == $factorye->id ) selected @endif>
                        ...
                        <div class="col-md-2 text-right">
                            <div class="mb-3">
                                Invoice No: <span class="mt-4 font-weight-bold" > {{$returnsdetails->invoice_no}}</span>

                                    <input type="hidden" class="form-control" placeholder="" value="{{$returnsdetails->invoice_no}}" name="invoice">
                                        ...
                                        <div class="col-md-10">
                                            <div class="row">
                                                    ...
                                                    <select class="form-control select2 products_id"
                                                        ...
                                                        @foreach ($products as $product)
                                                            <option style="color:#000;font-weight:600;"
                                                                value="{{ $product->id }}"  @if($item->product_id == $product->id ) selected @endif>{{ $product->product_name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="col-md-2">
                                                    ...
                                                    <input type="text" class="form-control p_price"  value="{{$item->unit_price}}" name="p_price[]" placeholder="Price">
                                                </div>
                                                <div class="col-md-2">
                                                    <label for="">Quantity :</label>
                                                    <input type="text" class="form-control p_qty" value="{{$item->qty}}" name="p_qty[]" placeholder="Quantity">
                                                </div>

                                                <div class="col-md-2">
                                                    <label for="">Total :</label>
                                                    <input type="hidden"  class="form-control total_price"  name="total_price[]" placeholder="total" value="{{$item->qty*$item->unit_price}}">
                                                    <input type="text" readonly class="form-control total_price_without_discount"  name="total_price_without_discount[]" value="{{$item->qty*$item->unit_price}}">
                            ...
                            <table class="table  border table-sm">
                                ...
                                <tfoot>
                                    <tr class="text-dark font-weight-bold">
                                        ...
                                        <input type="hidden" class="form-control " id="grand_total_qty"  name="grand_total_qty" value="{{$returnsdetails->total_qty}}">

                                    </tr>
                                    <tr class="text-dark font-weight-bold">
                                        <td >Total Price :</td>
                                        <td> <span id="total_value"></span></td>
                                        <input type="hidden" class="form-control " id="grand_total_value"  name="grand_total_value" value="{{$total}}">
                                    ...
                                    <tr class="text-dark font-weight-bold">
                                        ...
                                        <input type="hidden" class="form-control " id="total_payable"  name="total_payable" value="{{$total}}">
                    ...
                    <div class="row pb-5">
                        ...
                        <div class="col-md-4 mt-3">
                                 <button type="submit" class="btn custom-btn-sbms-submit" style="width: 100%"> Return Update </button>
                         </div>
                        <div class="col-md-4 mt-3">
