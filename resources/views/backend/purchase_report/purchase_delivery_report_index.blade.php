        ...
        <div class="content px-4 ">
            <div class="container">
                ...
                <div class="text-center pt-3">
                    <h5 class="text-uppercase font-weight-bold">Purchase Delivery Report Input</h5>
                    <hr>
                </div>
                <div class="form">
                    <form class="floating-labels m-t-40" action="{{ route('purchase.delivery.report') }}" method="POST">
                        @csrf
                        ...
                        <div class="class row">
                            ...
                            <div class="class col-md-4 px-5 py-5">
