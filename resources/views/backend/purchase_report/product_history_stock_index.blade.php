    ...
    <div class="content-wrapper">
        ...
        <div class="content px-4 ">
            <div class="container-fluid">
                ...
                <div class="form">
                    <form class="floating-labels m-t-40" action="{{ Route('product.history.stock.reportview') }}" method="POST">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group m-b-40">
                                    <select class="form-control selectpicker" data-show-subtext="true"
                                        data-live-search="true"  data-actions-box="true"  name="warehouse_id">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group m-b-40">
                                    <select class="form-control selectpicker" data-show-subtext="true"
                                        data-live-search="true"  data-actions-box="true"  name="product_id">
