        ...
        <div class="content px-4 ">
            <div class="container-fluid" style="background:#ffffff; padding:0px 40px;min-height:85vh">
                ...
                <div class="text-center pt-3">
                    <h5 class="text-uppercase font-weight-bold">C.O.G.M Report Input</h5>
                    <hr>
                </div>


                <div class="form">
                    <form class="floating-labels m-t-40" action="{{ Route('production.newCogm.report') }}" method="POST">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-4 ">
                                ...
                                <div class="form-group m-b-40">
                                    <div class="input-group">
                                        ...
                                        <input type="month" name="month"  class="form-control float-right" id="slectmonth" value="{{date('Y-m')}}" style="border-radius: 0px 5px 5px 0px!important;">
