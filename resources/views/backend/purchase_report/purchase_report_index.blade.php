        ...
        <div class="content px-4 ">
            <div class="container" style="background:#ffffff; padding:0px 40px;min-height:85vh">
                ...
                <div class="text-center pt-3">
                    <h5 class="text-uppercase font-weight-bold text-danger">Purchase Report Input</h5>
                    <hr>
                </div>

                <div class="form">
                    <form class="floating-labels m-t-40" action="{{ route('purchase.report') }}" method="POST">
                        @csrf
                        <div class="row" style="margin-top:20vh;">
                            ...
                            <div class="col-md-4">
                             ...
                             <div class="col-md-4" id="rawDiv">
                                <h5 class="text-primary ">Select Raw Products </h5>
                                <div class="form-group m-b-40">


                                    <select class="form-control selectpicker border border-secondary" data-show-subtext="true"
                                    data-live-search="true" data-actions-box="true" multiple
                                        name="product_id[]" id="raw">
                             ...
                             <div class="col-md-4" id="fgDiv">
                                <h5 class="text-primary ">Select F.G Products </h5>
                                <div class="form-group m-b-40">
                                    <select class="form-control selectpicker border border-secondary" data-show-subtext="true"
                                    data-live-search="true" data-actions-box="true" multiple
                                        name="fg_product_id[]" id="fg">
                                        @foreach ($fgProducts as $data)
                                            <option style="color: #ff0000; font-weight:bold" value="{{ $data->id }}">
                                                {{ $data->product_name }}
                                            </option>
                                        @endforeach
