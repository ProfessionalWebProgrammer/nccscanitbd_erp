        ...
        <div class="content px-4 ">
            <div class="container">
                ...
                <div class="text-center pt-3">
                    <h5 class="text-uppercase font-weight-bold">Monthly Purchase Report Input</h5>
                    <hr>
                </div>


                <div class="form">
                    <form class="floating-labels m-t-40" action="{{ Route('monthly.purchase.report') }}" method="POST">
                        @csrf
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group m-b-40">
                                    ...
                                    <select class="form-control selectpicker" data-show-subtext="true"
                                        data-live-search="true" data-actions-box="true"  name="month" required>
