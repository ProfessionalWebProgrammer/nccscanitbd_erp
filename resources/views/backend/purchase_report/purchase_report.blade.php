                            ...
                            @foreach ($suppliers as $supplier_data)
                                ...
                                @php
                                    $pur = DB::table('purchases')
                                        ->select('purchases.*',  'row_materials_products.product_name', 'factories.factory_name as wirehouse_name')
                                        ...
                                        ->where('purchases.raw_supplier_id',$supplier_data->id)
                                        ->whereBetween('purchases.date', [$fdate, $tdate]);

                                    $fgPurchase = DB::table('finish_goods_purchases')
                                                  ->select('finish_goods_purchases.date','finish_goods_purchases.invoice','finish_goods_purchases.transport_vehicle','finish_goods_purchases.transport_fare','finish_goods_purchases.net_payable_amount','f_g_purchase_detailes.*','sales_products.product_name','factories.factory_name as wirehouse_name')
                                                  ...
                                                  ->where('finish_goods_purchases.supplier_id', $supplier_data->id)
                                                  ->whereBetween('finish_goods_purchases.date', [$fdate, $tdate]);

                                    if ($wir) {
                                        $pur = $pur->whereIn('purchases.wirehouse_id', $wir);
                                        $fgPurchase = $fgPurchase->whereIn('finish_goods_purchases.warehouse_id', $wir);
                                    }

                                    $pur = $pur->get();
                                    $fgPurchase = $fgPurchase->get();
                                ...
                                @foreach ($pur as $purchas_data)
                                   ...
                                   @endphp
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="#">{{ $purchas_data->invoice }}</a></td>
                                ...
                                @endforeach
                                  @if($fgPurchase)
                                      ...
                                      @php
                                      $total_tf += $fgValue->transport_fare;
                                      $total_pay += $fgValue->net_payable_amount;

                                      $total_order += $fgValue->quantity;
                                      $total_recv += $fgValue->quantity;
                                      ...
                                      <tr>
                                          ...
                                          <td><a href="#">{{ $fgValue->invoice }}</a></td>
                                          <td style="text-align:center">{{ $fgValue->wirehouse_name }}</td>
                                          <td style="text-align:center">{{ $fgValue->transport_vehicle }}</td>
                                          <td style="text-align:center">{{ $fgValue->product_name }}</td>
