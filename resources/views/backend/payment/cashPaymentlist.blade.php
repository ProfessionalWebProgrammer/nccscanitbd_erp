            ...
            <div class="container" style="background:#ffffff; padding:0px 40px;min-height:85vh">
              ...
              <div class="row pt-3">
                      <div class="col-md-6 text-left">
                      	 <a href="{{ URL('/cash/payment/create') }}" class=" btn btn-success mr-2">Create Bank Payment</a>
                       </div>
                ...
                <div>
                    <div class="text-center">
                        <h5 class="text-uppercase font-weight-bold">Cash Payment List</h5>
                        <hr>
                    </div>

                    <form action="{{ route('cash.payment.index') }}" method="get">
                        <div class="row pb-4">
                                ...
                                <div class="col-md-8 input-group rounded">
                                    ...
                                    <div class="input-group-prepend pr-2">
                                        <a href="{{ route('cash.payment.index') }}" class="btn btn-sm btn-danger"><i class="far fa-times-circle"></i>
                                            Clear</a>
                                    </div>
                                    {{-- <div class="input-group-prepend">
                          ...
                          $gsname = DB::table('general_suppliers')->where('id',$item->general_supplier_id)->value('supplier_name')." (General Supplier)";
                            @endphp
                                <tr>
                                    ...
                                    <td class="align-middle">{{$item->supplier_name ? $item->supplier_name : $item->payment_description}} @if($item->general_supplier_id != null) {{$gsname}} @endif</td>
                                    ...
                                    <td class="text-center align-middle">
                                      ...
                                      <a class="btn btn-xs text-light btn-primary" href="{{route('cash.payment.view',$item->id)}}"
        ...
        <div class="modal fade" id="delete">
            <div class="modal-dialog">
                <div class="modal-content bg-danger">
                    ...
                    <form action="{{ route('cash.payment.delete') }}" method="POST">
                        {{ method_field('delete') }}
                        @csrf
