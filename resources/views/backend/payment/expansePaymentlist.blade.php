        ...
        <div class="content px-4 ">
           <div class="container" style="background:#f5f5f5; padding:0px 40px;min-height:85vh;min-width: 100%;">
             <div class="row pt-2">
                      ...
                      {{-- <a href="{{ route('expanse.type.create') }}" class=" btn btn-sm btn-warning mr-2"> Expence Type</a> --}}
 					 <a href="{{ route('expanse.SubSubGroup.create') }}" class=" btn btn-sm btn-success mr-2"> Expence Sub Ledger Create</a>
 					  {{--  <a href="{{ route('expanse.journal.create') }}" class=" btn btn-sm btn-warning mr-2"> Expence Journal Entry </a> --}}
                        <a href="{{ route('expanse.payment.return.index') }}" class=" btn btn-sm btn-danger mr-2"> Expence Return</a>
                        ...
                        <tbody>
                            ...
                            @foreach ($data as $item)
                                ...
                                $subSubgroup = DB::table('expanse_sub_subgroups')->where('id',$item->expanse_subSubgroup_id)->value('subSubgroup_name');
                          		$totalAmount = \App\Models\Payment::where('invoice',$item->invoice)->sum('amount');
                          if($item->supplier_id)
                          {
                                ...
                                @endphp
                                    <tr>
                                       ...
                                       <td class="align-middle">{{ $supplierName }}</td>
                                        ...
                                        <td class="text-right align-middle"> {{number_format($totalAmount, 2)}}/-</td>
