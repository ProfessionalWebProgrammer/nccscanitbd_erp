...
@section('content')
    ...
    <div class="content-wrapper">
       <div class="container" style="background:#ffffff; padding:0px 40px;">
            ...
            <form class="floating-labels m-t-40" action="{{route('expanse.payment.update')}}" method="POST">
                @csrf
                <div class="row">
                    <div class="col-md-12">
                                               ...
                                               <label class=" col-form-label"> Dealer:</label>
                                                               <select class="form-control select2 " id="dealer_id" name="dealer_id">
                                                                    ...
                                                                    @foreach ($allDealers as $data)
                                                                        <option style="color:#000;font-weight:600;" value="{{ $data->id }}"  @if($edata->dealer_id == $data->id) selected  @else  @endif> {{ $data->d_s_name }}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                  @endif
