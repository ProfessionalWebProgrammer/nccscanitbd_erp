...
@section('content')
    ...
    <div class="content-wrapper posclass">
        ...
        <div class="content px-4 ">
            ...
            <form action="{{route('manual.production.stock.out.store')}}" method="post">
                @csrf
                <div class="container" style="background:#ffffff; padding:0px 40px;min-height:85vh">
                  ...
                  <h5 class="mt-3 text-uppercase">Finish Good Stock Out</h5>
                                          ...
                                          <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="fg_qty[]" id="fg_qty">
                                                </div>
                                            </div>
                                          </div>
                                         </div>
                    ...
                    <div class="row pb-5">
                        ...
                        <div class="col-md-4 mt-3">
                            <button type="submit" id="customBtn" class="btn custom-btn-sbms-submit" style="width: 100%"> Confirm Stock Out
                            </button>
                        </div>
                        <div class="col-md-4 mt-3">
