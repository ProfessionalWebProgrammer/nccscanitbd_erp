...
@section('header_menu')
    <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ route('stockin.notification.list') }}" class=" btn btn-success mr-2">Notification List</a>
    </li>
@endsection
...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content px-4 ">
            <form action="{{ Route('stockin.notification.store') }}" method="POST">
                @csrf
                <div class="container-fluid pt-5">
                          ...
                          <div class="row mt-2">
                            ...
                            <div class="col-md-4 " ><h2>Stock Notification</h2></div>
                              <div class="col-md-4 ">
                            ...
                            <div class="col-md-4">
                                                <div class="form-group">
                                                  <label class=" col-form-label">Sales Product:</label>
                            ...
                            <div class="col-md-4"></div>
                               ...
                               <div class="col-md-3">
                                                <div class="form-group">
                                                    <label class=" col-form-label">Minimum Qunatity For Notification:</label>
