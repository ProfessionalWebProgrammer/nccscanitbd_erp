                    ...
                    <div class="row pt-4">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="date" value="{{ $finishGood->date }}" class="form-control" name="date">
                            </div>
                        </div>
                       <div class="col-md-3">
                            <div class="form-group">
                                <label for="inputEmail3" class="col-form-label">Expire Day : </label>
                                <input type="number" class="form-control" name="expire_date" value="{{ $finishGood->expire_date }}">
                            </div>
                        </div>
                       ...
                       <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="referance" value="{{ $finishGood->referance }}">
                            </div>
                        </div>
                     {{-- <div class="col-md-2">
                            <div class="form-group">
                         ...
                         <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="batch" value="{{ $finishGood->batch }}">
                            ...
                            <div class="form-group">
                                    ...
                                    <select name="production_factory_id"  class="form-control select2" >
                                        ...
                                        @foreach ($pfactory as $item)
                                            <option value="{{ $item->id }}" @if($finishGood->production_factory_id == $item->id) selected  @else  @endif  >{{ $item->factory_name }}</option>
                                        @endforeach
                                    </select>
                            </div>
                      </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="wirehouse_id"  class="form-control select2" required>
                                    ...
                                    @foreach ($stores as $item)
                                        <option value="{{ $item->id }}" @if($finishGood->factory_id == $item->id) selected  @else  @endif>{{ $item->factory_name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="finish_goods_id" class="form-control select2" id="finish_goods_id" required>
                                    ...
                                    @foreach ($finishedgoods as $item)
                                        <option value="{{ $item->id }}" @if($finishGood->prouct_id == $item->id) selected @else  @endif >{{ $item->product_name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="fg_qty"  id="fg_qty" value="{{ $finishGood->quantity }}">
                            </div>
                        </div>
                      <div class="col-md-3">
                            <div class="form-group">
                    ...
                    <div class="row mt-3">
                        <div id="field" class="col-md-12">
                            ...
                            <div class="row fieldGroup  mb-3 ">
                               <div class="col-md-12">
                                  <div class="row">
                                    <div class="col-md-4"> <select class="form-control select2 product_id" name="product_id[]"  >
                                       @foreach ($products as $product) <option style="color:#000;font-weight:600;" value="{{ $product->id }}" @if($raw->product_id == $product->id)  selected @else  @endif >{{ $product->product_name }}</option> @endforeach </select>
                                      </div>
                                      <div class="col-md-2"> <input type="text" class="form-control " readonly  name="u_qty[]" value=""> </div>
                                      <div class="col-md-2"> <input type="text" class="form-control p_qty"  name="p_qty[]" value="{{ $raw->stock_out_quantity }}"> </div>
                                      <div class="col-md-2"> <input type="text" class="form-control stock_value" readonly name="stock[]" value="{{ $raw->stock_opening }}"> </div>
                                      {{-- <div class="col-md-2"> <input type="text" class="form-control remaning" name="remaning[]" readonly placeholder="Remaining Stock"> </div> --}}
                                    </div>
                                  </div>
                                </div>
                            @endforeach
