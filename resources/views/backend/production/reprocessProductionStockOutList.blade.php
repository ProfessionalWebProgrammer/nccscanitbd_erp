            ...
            <div class="container-fluid" style="background:#ffffff; padding:0px 40px;min-height:85vh">
              <div class="row">
                      <div class="col-md-12 text-right pt-3">
                          ...
                          <a href="{{route('reprocess.production.stock.out.create')}}" class="btn btn-sm btn-info">Reprocess Create</a>
                ...
                <div class="py-4 table-responsive">
                  <div class="text-center pt-3">
                    <h5 class="text-uppercase font-weight-bold">Reprocess Finish Goods Stock Out List</h5>
                 </div>
                               ...
                               {{--  
                                 <a href="{{route('production.stock.out.checkout',$data->sout_number)}}" class="btn btn-xs btn-info purchaseedit">Checkout Invoice</span></a>
                                   <a href="#" class="btn btn-xs btn-danger purchasedelete" data-myid="{{ $data->sout_number }}"
                   				 ...
                   				 <a href="{{route('reprocess.production.stock.out.delete',$data->id)}}" target="_blank" class="btn btn-xs btn-danger purchasedelete"><i class="far fa-trash-alt"></i></a>
                                </td>
                          </tr>
                            @endforeach
