...
@section('content')
    ...
    <div class="content-wrapper posclass">
        ...
        <div class="content px-4 ">
            ...
            <form action="{{route('production.fg.set.store')}}" method="post">
                @csrf
                <div class="container" style="background:#ffffff; padding:0px 40px;min-height:85vh">
                  <div class="row">
                      <div class="col-md-12 text-center pt-3">
                          <h3 class="text-uppercase">Finised Good Production Set </h3>
                    ...
                    <div class="row pt-4">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="fg_qty">
                            </div>
                        </div>
                    ...
                    <div class="row pb-5 mt-3">
                        ...
                        <div class="col-md-2 m-auto">
                            <button type="submit" class="btn custom-btn-sbms-submit" style="width: 100%"> Confirm Stock Out
                            </button>
                        </div>
                        <div class="col-md-5">
