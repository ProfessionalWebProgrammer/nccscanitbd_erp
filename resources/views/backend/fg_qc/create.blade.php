...
<style media="screen">
    ...
    <div class="content-wrapper">
        ...
        <form class="floating-labels m-t-40" action="{{route('fgQualityControl.store')}}" method="POST">
            @csrf
                                        ...
                                        <label class=" col-form-label col-md-4 pl-3"> Product Name:</label>
                                         <select name="product_id" class="form-control select2 col-md-8 " required>
                                                <option value="">== Seleter Product ==</option>
                                                 @foreach ($products as $item)
                                                <option value="{{$item->prouct_id}}">{{$item->name}}</option>
                                                @endforeach
                                         </select>
                                   </div>
                            </div>
                           {{-- <div class="col-md-3">
                                  <div class="form-group row">
                                      <label class=" col-form-label col-md-4">Quantity:</label>
                                    	<input type="number" name="qty" class="form-control col-md-8" value="">
                                   </div>
                               </div> --}}
                               <div class="col-md-4">
                                     <div class="form-group row">
