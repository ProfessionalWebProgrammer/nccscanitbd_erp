            ...
            <div class="row">
                <div class="col-md-6" style="border-right: 2px solid black">
                    <div class="container-fluid">
                        <form class="floating-labels m-t-40" action="{{ route('fg.qc.parameter.store') }}" method="POST">
                            @csrf
                            <div class="px-3">
                                <div class="pt-3 text-center">
                                    <h5 class="font-weight-bolder text-uppercase">Create F G Q C Parameter</h5>
                                    <hr width="33%">
                                </div>
                                <div class="row">
                        ...
                        <div class="px-3">
                            <div class="py-4">
                                <div class="text-center">
                                    <h5 class="text-uppercase font-weight-bold">F G Q C Parameter List</h5>
                                    <hr>
                                </div>
    ...
    <div class="modal fade" id="delete">
        <div class="modal-dialog">
            <div class="modal-content bg-danger">
                ...
                <form action="{{  route('fg.qc.parameter.delete') }}" method="POST">
                    {{ method_field('delete') }}
                    @csrf

                    <div class="modal-body">
                        <p>Are you sure to delete this F G Q C Parameter?</p>
