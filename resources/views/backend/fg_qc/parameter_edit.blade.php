            ...
            <div class="container-fluid">
                <div class="row pt-5">
                    <div class="col-md-6 m-auto">
                        <form class="floating-labels m-t-40" action="{{ route('fg.qc.parameter.update', $data->id) }}" method="POST">
                            @csrf
                            <div class="px-3">
                                <div class="pt-3 text-center">
                                    <h5 class="font-weight-bolder text-uppercase">Edit F G Q C Parameter Group</h5>
                                    <hr width="33%">
                                </div>
                                <div class="row">
