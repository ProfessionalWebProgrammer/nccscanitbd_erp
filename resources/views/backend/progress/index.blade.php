...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <a href="{{ URL('/progress/create') }}" class=" btn btn-success btn-sm mt-1 mr-2">Progress Entry</a>
    </li>
                ...
                <div>
                    <div class="text-center">
                        <h5 class="text-uppercase font-weight-bold">Progress List</h5>
                        <hr>
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center align-middle">
                                      <a class="btn btn-sm text-light btn-primary"
                                            href="{{ URL::to('/view/progress/' . $item->id) }}" data-toggle="tooltip"
