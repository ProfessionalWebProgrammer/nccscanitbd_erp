        ...
        <div class="content px-4 ">
            <div class="row">
                <div class="col-md-6" style="border-right: 2px solid black">
                    ...
                    <form class="floating-labels m-t-40" action="{{ Route('others.type.store') }}" method="POST">
                        @csrf

                        <div class="container-fluid">
                            <div class="pt-3 text-center">
                                <h4 class="font-weight-bolder text-uppercase">Others Type Create</h4>
                                <hr width="33%">
                            </div>
                            ...
                            <div class="row pt-4">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" name="name" class="form-control" placeholder="Others Type Title">
                                </div>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" name="description" class="form-control"
                                        placeholder="Others Type Description">
                                </div>
                        ...
                        <div class="container-fluid">
                            <div class="py-4">
                                <div class="text-center">
                                    <h5 class="text-uppercase font-weight-bold">Others Type List</h5>
                                    <hr>
                                </div>
                                        ...
                                        @foreach ($otherstypes as $item)
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center align-middle">
                                                    <a class="btn btn-sm mb-1 accountsedit"
    ...
    <div class="modal fade" id="delete">
        <div class="modal-dialog">
            <div class="modal-content bg-danger">
                ...
                <form action="{{ route('others.type.delete') }}" method="POST">
                    {{ method_field('delete') }}
                    @csrf
