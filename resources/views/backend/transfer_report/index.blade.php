        ...
        <div class="content px-4 ">
            <div class="container" style="background:#ffffff; padding:0px 40px;min-height:85vh">
                ...
                <div class="text-center pt-3">
                    <h5 class="text-uppercase font-weight-bold">F.G Transfer Report Input</h5>
                    <hr>
                </div>


                <div class="form">
                    <form class="floating-labels m-t-40" action="{{ Route('fgTransfer.report.view') }}" method="POST">
                        @csrf
                        <div class="row">
