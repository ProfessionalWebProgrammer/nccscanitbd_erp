        ...
        <div class="content px-4 ">
            <div class="container" style="background:#ffffff; padding:0px 40px;min-height:85vh">
                ...
                <div class="text-center pt-3">
                    <h5 class="text-uppercase font-weight-bold">F.G Transfer Short Summary Report Input</h5>
                    <hr>
                </div>


                <div class="form">
                    <form class="floating-labels m-t-40" action="{{ Route('fgTransfer.short.summary.report.view') }}" method="POST">
                        @csrf
                        <div class="row">
                           ...
                           <div class="col-md-3">
                                ...
                                <div class="form-group m-b-40">
                                    <select class="form-control selectpicker" data-show-subtext="true"
                                        data-live-search="true"  data-actions-box="true" multiple name="cat_id[]">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group m-b-40">
                                    <select class="form-control selectpicker" data-show-subtext="true"
                                        data-live-search="true"  data-actions-box="true" multiple name="wirehouse_id[]">
                                         @foreach ($wirehouses as $p)
                                            <option style="color: #FF0000" value="{{ $p->id }}"
                                                >{{ $p->factory_name }}
                                            </option>
                                        @endforeach
