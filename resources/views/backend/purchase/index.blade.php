...
@section('content')
    ...
    <div class="content-wrapper" style="background: #1e2225;">


        <!-- Main content -->
        <div class="content px-4 " >
            <div class="container" style="background: rgb(35 40 45);color:#333; padding:0px 40px;min-height:85vh">

                <div class="text-center pt-3">
                    <h5 class="text-uppercase font-weight-bold">Purchase List Input</h5>
                    <hr>
                </div>


                <div class="form">
                    <form class="floating-labels m-t-40" action="{{ Route('purchase.list') }}" method="POST">
                        @csrf
                        <div class="row">
