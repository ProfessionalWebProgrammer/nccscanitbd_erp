...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content px-4 ">
            ...
            <form class="floating-labels m-t-40" action="{{ Route('purchase.bag.update') }}" method="POST">
                @csrf

                <div class="container" style="background:#ffffff; padding:0px 40px;min-height:85vh">
                    <div class="text-center py-4">
                        <h3 class="text-uppercase font-weight-bold">Edit Purchase Bag</h3>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="date" id="data" name="date" value="{{$purchases->date}}" class="form-control">
                        </div>

                        <div class="col-md-4">
                            <label class="col-form-label text-right">Reference :</label>
                            <input type="Text" class="form-control" value="{{$purchases->reference}}"  name="reference" placeholder="Reference">
                        </div>

                        <div class="col-md-4">
                            <label class="col-form-label text-right">Transport Vehicle: </label>
                            <input type="Text" id="vehicle" name="transport_vehicle" value="{{$purchases->transport_vehicle}}" class="form-control" placeholder="Transport Vehicle">
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-control select2" name="raw_supplier_id" id="supplier_id" required>
                                ...
                                @foreach ($suppliers as $supplier)
                                    <option style="color:#000;font-weight:600;" value="{{ $supplier->id}}" @if($supplier->id == $purchases->raw_supplier_id) selected @endif>
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-control select2" name="wirehouse_id" id="wirehouse" required>
                                ...
                                @foreach ($factoryes as $factorye)
                                    <option style="color:#000;font-weight:600;" value="{{ $factorye->id }}" @if($factorye->id == $purchases->wirehouse_id) selected @endif>
                                        ...
                                        <div class="col-md-11">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    ...
                                                    <select class="form-control select2" name="product_id[]" required>
                                                        ...
                                                        @foreach ($rm_products as $data)
                                                            <option style="color:#000;font-weight:600;" value="{{ $data->id }}" @if($data->id == $item->product_id) selected @endif>
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    <input type="text" class="form-control p_qty" value="{{$item->bill_quantity}}" name="p_qty[]" placeholder="Quantity">
                                                </div>

                                                <div class="col-md-2">
                                                    <label for="">Rate :</label>
                                                    <input type="text" class="form-control p_price" value="{{$item->purchase_rate}}" name="p_price[]" placeholder="Price">
                                                </div>
                                                
                                                <div class="col-md-3">
                                                    <label for="">Total  value:</label>
                                                    <input type="hidden" readonly class="form-control total_price" value="{{$item->amount}}"  name="total_price[]" placeholder="total">
                                                    <input type="text" class="form-control total_price_without_discount" disabled  value="{{$item->amount}}" name="total_price_without_discount[]">
                         ...
                         <div class="row mt-3">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="any" class="form-control " value="{{$purchases->transport_fare}}" id="transport_fare" name="transport_fare"
