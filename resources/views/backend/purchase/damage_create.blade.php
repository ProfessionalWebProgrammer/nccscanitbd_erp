...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content px-4 ">
            <form action="{{ route('purchase.damage.store') }}" method="post">
                @csrf
                <div class="container" style="background:#ffffff; padding:0px 40px;min-height:85vh">
                    <div class="text-center py-4">
                        <h3 class="text-uppercase font-weight-bold text-danger">Create Purchase Damage</h3> <hr>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-4 col-form-label text-right text-primary">Warehouse
                                </label>
                                <div class="col-sm-8">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 pr-3">
                                                <div class="form-group row">
                                                    ...
                                                    <input type="text" required name="quantity[]" class="form-control amount"
                ...
                <div class="row my-4">
                    <div class="col-md-6  m-auto font-weight-bold">
                        <h5 class="text-center "><strong>Total Quantity : <span id="total_amount"></span>/-</strong></h5>
                    </div>
