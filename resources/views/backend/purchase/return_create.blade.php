                ...
                <div class="container-fluid" style="background:#ffffff; padding:0px 40px;min-height:85vh">
                    ...
                    <div class="row pt-5">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="Text" id="vehicle" name="vehicle_no" class="form-control" placeholder="Transport Vehicle">

                        </div>

                        <div class="col-md-4">
                            <label class="col-form-label text-right text-primary">Transport Fare: </label>
                            <input type="Text" id="vehicle" name="transport_fare" class="form-control" placeholder="Transport Fare">
                        ...
                        <div class="col-md-4">
                            <label style="padding-top: 10px; text-primary"> Warehouse Name:</label>
                            <select class="form-control select2" name="wirehouse_id" id="wirehouse" required>
                                <option value="" class="text-primary">Select Warehouse</option>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 pr-3">
                                                    <div class="form-group row">
                                                        ...
                                                        <input type="text" required name="return_quantity" class="form-control amount"
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group row">
                                                        ...
                                                        <input type="text" name="return_rate" class="form-control p_price"
                                                            placeholder="Rate">
                                                    </div>
                                                </div>
                                            </div>
    ...
    <script>
        $(document).ready(function() {
          ...
          $('.product_id').on('change',function(){
                      ...
                      $.ajax({
                              url : '{{url('/item/purchase/value/')}}/'+id+'/'+supplier,
                              type: "GET",
                              dataType: 'json',
                              success : function(data){
                                ...
                                //  parent.find('.stock').val(data.stock);
                                  $('.p_price').val(data.rate);
                                } else {
                                  alert("Sorry! This Item has not purchased yet now.");
                                }
