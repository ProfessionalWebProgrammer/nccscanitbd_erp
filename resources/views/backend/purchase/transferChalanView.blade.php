    ...
    <div class="content-wrapper">
        ...
        <div class="content px-4 ">
            <div class="container-fluid" id="cardbody">
                ...
                <div class="text-center pt-3">
                    <h5 class="text-uppercase font-weight-bold">Purchase Transfer Chalan View</h5>
                   <hr>
                </div>
                <div class="row pt-4">
                            ...
                            <div class="mt-3">
                                <table style="font-size:16px;">
                                    <tr>
                      				...
                      				<tr>
                                        <td></b>{{$data->toWarehose->factory_name}}</b></td>
                                    </tr>
          							                   <tr class="mt-3">
                                        <td></b>From</b></td>
                                    </tr>
                      				<tr>
                                        <td></b>{{$data->fromWarehose->factory_name}}</b></td>
                                    </tr>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mt-5">
                        <table id="" class="table table-bordered table-striped table-fixed" style="font-size:18px; font-weight:500;">
                            ...
                            <tbody>
                               ...
                               @if($item->qty > 0)
                                <tr>
                                    ...
                                    <td  align="center">{{number_format($item->receive_qty,0)}}</td>
                                </tr>
								@else
                            ...
                            <tfooter>
                            <tr>
                              <td colspan="100%">Note: {{$data->narration}}</td>
                            </tr>
                          </tfooter>
                        </table>
                    </div>
