              ...
              <div class="row pt-3">
                <div class="col-md-3"></div>
                  	<div class="col-md-9 text-right">
                      	<a href="{{route('rental.rentalProfile.create')}}" class="btn btn-sm btn-success">Rental Profile Create </a>
                      	<a href="{{route('rentalGoodsReceivedIndex')}}" class="btn btn-sm btn-success">Rental Goods Received </a>
                ...
                <div class="py-4">
                    <div class="text-center">
                        <h5 class="text-uppercase font-weight-bold">Rental Organization List</h5>
                        <hr>
                    </div>

                    <table id="example3" class="table table-bordered table-striped" style="font-size: 11px;">
                        <thead>
                        ...
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>Mr. Anamul Haque</td>
                                    <td>Dhaka </td>
                                    <td>8820974657 </td>
                                    <td>01734652347 </td>
                                    <td>abc@gmail.com </td>
                                    <td>Courier Services </td>
                                    <td>Global Courier Services </td>
                                    <td align="center">50,000 /- </td>
                                    <td><img class="gallery" style="height:50px;" src="{{URL::to('/public/uploads/rental/1.png')}}" alt="Image"> </td>
