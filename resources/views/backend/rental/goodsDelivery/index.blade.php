              ...
              <div class="row pt-3">
                <div class="col-md-3"></div>
                  	<div class="col-md-9 text-right">
                      	...
                      	<a href="{{route('rental.rentalGoodsDelivery.create')}}" class="btn btn-sm btn-success">Create Delivery</a>
                ...
                <div class="py-4">
                    <div class="text-center">
                        <h5 class="text-uppercase font-weight-bold">Rental Goods Delivery List</h5>
                        <hr>
                    </div>
