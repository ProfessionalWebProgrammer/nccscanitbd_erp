              ...
              <div class="row pt-3">
                <div class="col-md-3"></div>
                  	<div class="col-md-9 text-right">
                      	...
                      	<a href="{{route('rental.rentalGoodsDeliveryCollection.create')}}" class="btn btn-sm btn-success">Create Collection</a>
                    </div>
                </div>
                ...
                <div class="py-4">
                    <div class="text-center">
                        <h5 class="text-uppercase font-weight-bold">Rental Goods Delivery Collection List</h5>
                        <hr>
                    </div>
