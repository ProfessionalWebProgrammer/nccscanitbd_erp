@extends('layouts.tenderBidding_dashboard')
       ...
       <div class="row">
        ...
        <div class="row pt-3">
            <div class="col-md-4 m-auto sales_main_button">
                ...
                <a href="{{route('tenderBidding.dashboard')}}" class="text-center pt-1 pb-2 py-3 btn btn-block  text-center linkbtn">Project Management Department</a>
            </div>
        </div>
          ...
          <div class="row pt-5 px-3 text-center">
            ...
            <div class="col-md-2 p-1 sales_button" style="border-radius: 8px;">
                <div class="mx-1">
                  <a href="#" class="btn btn-block  text-center py-3 linkbtn">Bidding Section</a>
                </div>
            </div>
            <div class="col-md-2 p-1 sales_button" style="border-radius: 8px;">
                <div class="mx-1">
                  <a href="#" class="btn btn-block  text-center py-3 linkbtn">Bidding Schedule</a>
                </div>
            </div>
            <div class="col-md-2 p-1 sales_button" style="border-radius: 8px;">
                <div class="mx-1">
                  <a href="#" class="btn btn-block  text-center py-3 linkbtn">Project Details</a>
                </div>
            </div>
