       ...
       <div class="row">
        ...
        <div class="row pt-3">
            <div class="col-md-4 m-auto sales_main_button">
                <a href="{{route('hrpayroll.dashboard')}}" class="text-center pt-1 pb-2 py-3 btn btn-block  text-center linkbtn" >HR & Payroll Department</a>
            </div>
        </div>
          ...
          <div class="row pt-5 px-3 text-center">
            ...
            <div class="col-md-2 p-1 sales_button" style="border-radius: 8px;">
                <div class="mx-1">
                  <a href="{{route('employee.management.list')}}" class="btn btn-block  text-center py-3 linkbtn">E. Management</a>
                </div>
            </div>
            <div class="col-md-2 p-1 sales_button" style="border-radius: 8px;">
                <div class="mx-1">
                  <a href="{{route('employee.time.attendance')}}" class="btn btn-block  text-center py-3 linkbtn">Time & Attendance</a>
                </div>
            </div>
            <div class="col-md-2 p-1 sales_button" style="border-radius: 8px;">
                <div class="mx-1">
                  <a href="{{route('employee.pay.roll.list')}}" class="btn btn-block  text-center py-3 linkbtn">Pay Roll</a>
                </div>
            </div>
            <div class="col-md-2 p-1 sales_button" style="border-radius: 8px;">
                <div class="mx-1">
                  <a href="{{route('employee.pay.rollReport')}}" class="btn btn-block  text-center py-3 linkbtn">Reports</a>
                </div>
            </div>
            @endif
