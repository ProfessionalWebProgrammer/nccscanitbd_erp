            ...
            <div class="container-fluid" style="background: #ffffff; padding: 0px 40px;">
              	<div class="row pt-3">
                  	<div class="col-md-12 text-right">
                        <a href="{{route('inter.company.create')}}" class="btn btn-sm btn-success">Create Inter Company </a>
                    </div>
                </div>
                        ...
                        <tbody>
                            @foreach ($company as $data)
                                ...
                                <tr>
                                    ...
                                    <td>{{ $data->address }}</td>
                                    <td>{{ $data->balance }}</td>
                                    <td align="center">@if($data->status == 1) <span class="badge badge-success p-2"> Active </span> @else <span class="badge badge-warning p-2"> Inactive </span> @endif </td>
    ...
    <div class="modal fade" id="delete">
            <div class="modal-dialog">
                <div class="modal-content bg-danger">
                    ...
                    <form action="{{route('inter.company.delete')}}" method="POST">
                        {{ method_field('delete') }}
                        @csrf
