...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <form class="floating-labels m-t-40" action="{{Route('row.materials.store')}}" method="POST">
            @csrf
                ...
                <div class="row pt-4">
                    <div class="col-md-8 m-auto">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="unit" class="form-control" placeholder="Product Unit">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label text-primary">Product Rate:</label>
                            <div class="col-sm-9">
                                <input type="number" name="rate" class="form-control" placeholder="Product Rate" step="any">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        {{-- <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="Text" name="opening_balance" class="form-control" placeholder="Opening Balance">
						            ...
						            <div class="form-group row">
                            <label class="col-sm-3 col-form-label text-primary"> Live Days : </label>
                            <div class="col-sm-9">
                                <input type="number" name="days" class="form-control" placeholder="Product Live Days Exm: 10">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label text-primary"> Minimum Stock Quantity : </label>
                            <div class="col-sm-9">
                                <input type="Text" name="min_stock" class="form-control" placeholder="Product Minimum Stock Quantity Exm: 25" required>
                            </div>
                        </div>
